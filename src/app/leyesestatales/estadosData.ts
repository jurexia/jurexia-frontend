...
const JALISCO_LEYES: CategoriaLeyes = {
    constitucion: [
        { nombre: 'Constitución Política del Estado de Jalisco', url: `${JALISCO_BASE}/Constitución Política del Estado de Jalisco-241125.pdf` },
    ],
    leyes: [
        ...
        { nombre: 'Declaratoria de Inicio de Vigencia de la Ley Nacional de Extinción de Dominio en el Territorio del Estado de Jalisco', url: `${JALISCO_BASE}/Declaratoria de Inicio de Vigencia de la Ley Nacional de Extinción de Dominio en el Territorio del Estado de Jalisco.pdf` },
        { nombre: 'Declaratoria de incorporación a la Ley Nacional de Mecanismos Alternativos de solución de controversias', url: `${JALISCO_BASE}/Declaratoria de incorporación a la Ley Nacional de Mecanismos Alternativos de solución de controversias.-100223.pdf` },
        { nombre: 'Declaratoria de incorporación del Sistema Procesal Penal Acusatorio', url: `${JALISCO_BASE}/Declaratoria de incorporación del Sistema Procesal Penal Acusatorio-100223.pdf` },
        { nombre: 'Declaratoria del Área Metropolitana de Guadalajara', url: `${JALISCO_BASE}/Declaratoria del Área Metropolitana de Guadalajara-130223.pdf` },
        { nombre: 'Declaratoria para el inicio de vigencia de la Ley Nacional de Ejecución Penal en el Territorio del Estado de Jalisco', url: `${JALISCO_BASE}/Declaratoria para el inicio de vigencia de la Ley Nacional de Ejecución Penal en el Territorio del Estado de Jalisco-130223.pdf` },
        { nombre: 'Decreto 17114, Regularización de Predios Rústicos del Estado de Jalisco', url: `${JALISCO_BASE}/Decreto 17114, Regularización de Predios Rústicos del Estado de Jalisco-261125.pdf` },
        ...
        { nombre: 'Ley Estatal del Equilibrio Ecológico y la Protección al Ambiente', url: `${JALISCO_BASE}/Ley Estatal del Equilibrio Ecológico y la Protección al Ambiente-181225.pdf` },
        ...
        { nombre: 'Ley Estatal para Promover la Igualdad, Prevenir y Eliminar la Discriminación en el Estado de Jalisco', url: `${JALISCO_BASE}/Ley Estatal para Promover la Igualdad, Prevenir y Eliminar la Discriminación en el Estado de Jalisco-271023.pdf` },
        ...
        { nombre: 'Ley Organica del Organismo Púlblico descentralizado denominado Museos, Exposiciones y Galerías de Jalisco', url: `${JALISCO_BASE}/Ley Organica del Organismo Púlblico descentralizado denominado Museos, Exposiciones y Galerías de Jalisco-191022.pdf` },
        { nombre: 'Ley Orgánica de la Agencia Estatal de Entretenimiento de Jalisco', url: `${JALISCO_BASE}/Ley Orgánica de la Agencia Estatal de Entretenimiento de Jalisco-300424.pdf` },
        { nombre: 'Ley Orgánica de la Agencia de Conectividad y Acceso a Internet', url: `${JALISCO_BASE}/Ley Orgánica de la Agencia de Conectividad y Acceso a Internet-271123.pdf` },
        { nombre: 'Ley Orgánica de la Agencia de Energía del Estado de Jalisco', url: `${JALISCO_BASE}/Ley Orgánica de la Agencia de Energía del Estado de Jalisco-020323.pdf` },
        { nombre: 'Ley Orgánica de la Agencia para el Desarrollo de Industrias Creativas y Digitales del Estado de Jalisco', url: `${JALISCO_BASE}/Ley Orgánica de la Agencia para el Desarrollo de Industrias Creativas y Digitales del Estado de Jalisco-020323.pdf` },
        { nombre: 'Ley Orgánica de la Fiscalía del Estado de Jalisco', url: `${JALISCO_BASE}/Ley Orgánica de la Fiscalía del Estado de Jalisco-070225.pdf` },
        { nombre: 'Ley Orgánica de la Procuraduría Social del Estado de Jalisco', url: `${JALISCO_BASE}/Ley Orgánica de la Procuraduría Social del Estado de Jalisco -020323.pdf` },
        { nombre: 'Ley Orgánica de la Universidad Intercultural de Jalisco', url: `${JALISCO_BASE}/Ley Orgánica de la Universidad Intercultural de Jalisco-080725.pdf` },
        { nombre: 'Ley Orgánica de la Universidad Politécnica de la Zona Metropolitana de Guadalajara', url: `${JALISCO_BASE}/Ley Orgánica de la Universidad Politécnica de la Zona Metropolitana de Guadalajara-290523.pdf` },
        { nombre: 'Ley Orgánica de la Universidad Tecnológica de Jalisco', url: `${JALISCO_BASE}/Ley Orgánica de la Universidad Tecnológica de Jalisco-310523.pdf` },
        { nombre: 'Ley Orgánica de la Universidad Tecnológica de la Zona Metropolitana de Guadalajara', url: `${JALISCO_BASE}/Ley Orgánica de la Universidad Tecnológica de la Zona Metropolitana de Guadalajara-310523.pdf` },
        { nombre: 'Ley Orgánica de la Universidad de Guadalajara', url: `${JALISCO_BASE}/Ley Orgánica de la Universidad de Guadalajara-020323.pdf` },
        { nombre: 'Ley Orgánica del Colegio de Bachilleres del Estado de Jalisco', url: `${JALISCO_BASE}/Ley Orgánica del Colegio de Bachilleres del Estado de Jalisco-290523.pdf` },
        { nombre: 'Ley Orgánica del Colegio de Educación Profesional Técnica del Estado de Jalisco', url: `${JALISCO_BASE}/Ley Orgánica del Colegio de Educación Profesional Técnica del Estado de Jalisco-030323.pdf` },
        { nombre: 'Ley Orgánica del Colegio de Estudios Científicos y Tecnológicos del Estado de Jalisco', url: `${JALISCO_BASE}/Ley Orgánica del Colegio de Estudios Científicos y Tecnológicos del Estado de Jalisco-260523.pdf` },
        { nombre: 'Ley Orgánica del Instituto Cultural Cabañas', url: `${JALISCO_BASE}/Ley Orgánica del Instituto Cultural Cabañas-100323.pdf` },
        { nombre: 'Ley Orgánica del Instituto Jalisciense de Ciencias Forenses Dr. Jesús Mario Rivas Souza', url: `${JALISCO_BASE}/Ley Orgánica del Instituto Jalisciense de Ciencias Forenses Dr. Jesús Mario Rivas Souza-181024.pdf` },
        { nombre: 'Ley Orgánica del Instituto Jalisciense de la Vivienda', url: `${JALISCO_BASE}/Ley Orgánica del Instituto Jalisciense de la Vivienda.pdf` },
        { nombre: 'Ley Orgánica del Instituto Tecnológico José Molina Pasquel y Henríquez', url: `${JALISCO_BASE}/Ley Orgánica del Instituto Tecnológico José Molina Pasquel y Henríquez-171023.pdf` },
        { nombre: 'Ley Orgánica del Instituto de Información Estadística y Geográfica del Estado de Jalisco', url: `${JALISCO_BASE}/Ley Orgánica del Instituto de Información Estadística y Geográfica del Estado de Jalisco-300523.pdf` },
        { nombre: 'Ley Orgánica del Organismo Público Descentralizado Denominado Agencia de Coinversión para el Desarrollo Sostenible de Jalisco (Coinvierte)', url: `${JALISCO_BASE}/Ley Orgánica del Organismo Público Descentralizado Denominado Agencia de Coinversión para el Desarrollo Sostenible de Jalisco (Coinvierte)-100323.pdf` },
        { nombre: 'Ley Orgánica del Organismo Público Descentralizado denominado Agencia Integral de Regulación de Emisiones', url: `${JALISCO_BASE}/Ley Orgánica del Organismo Público Descentralizado denominado Agencia Integral de Regulación de Emisiones-060326.pdf` },
        { nombre: 'Ley Orgánica del Organismo Público Descentralizado denominado Centro de Conciliación Laboral del Estado de Jalisco', url: `${JALISCO_BASE}/Ley Orgánica del Organismo Público Descentralizado denominado Centro de Conciliación Laboral del Estado de Jalisco-240323.pdf` },
        { nombre: 'Ley Orgánica del Organismo Público Descentralizado denominado Centro de Coordinación, Comando, Control, Comunicaciones y Cómputo del Estado de Jalisco', url: `${JALISCO_BASE}/Ley Orgánica del Organismo Público Descentralizado denominado Centro de Coordinación, Comando, Control, Comunicaciones y Cómputo del Estado de Jalisco-150125.pdf` },
        { nombre: 'Ley Orgánica del Organismo Público Descentralizado denominado Red de Centros de Justicia para las Mujeres', url: `${JALISCO_BASE}/Ley Orgánica del Organismo Público Descentralizado denominado Red de Centros de Justicia para las Mujeres-240323.pdf` },
        { nombre: 'Ley Orgánica del Poder Ejecutivo del Estado de Jalisco', url: `${JALISCO_BASE}/Ley Orgánica del Poder Ejecutivo del Estado de Jalisco-150125.pdf` },
        { nombre: 'Ley Orgánica del Poder Judicial del Estado de Jalisco', url: `${JALISCO_BASE}/Ley Orgánica del Poder Judicial del Estado de Jalisco-240323.pdf` },
        { nombre: 'Ley Orgánica del Poder Legislativo del Estado de Jalisco', url: `${JALISCO_BASE}/Ley Orgánica del Poder Legislativo del Estado de Jalisco -071024.pdf` },
        { nombre: 'Ley Orgánica del Sistema Jalisciense de Radio y Televisión', url: `${JALISCO_BASE}/Ley Orgánica del Sistema Jalisciense de Radio y Televisión-240323.pdf` },
        { nombre: 'Ley Orgánica del Tribunal Electoral del Estado de Jalisco', url: `${JALISCO_BASE}/Ley Orgánica del Tribunal Electoral del Estado de Jalisco-270323.pdf` },
        { nombre: 'Ley Orgánica del Tribunal de Justicia Administrativa del Estado de Jalisco', url: `${JALISCO_BASE}/Ley Orgánica del Tribunal de Justicia Administrativa del Estado de Jalisco-240323.pdf` },
        { nombre: 'Ley Orgánica que crea al Organismo Público Descentralizado denominado Plataforma Abierta de Innovación y Desarrollo de Jalisco', url: `${JALISCO_BASE}/Ley Orgánica que crea al Organismo Público Descentralizado denominado Plataforma Abierta de Innovación y Desarrollo de Jalisco-171023.pdf` },
        { nombre: 'Ley Reglamentaria del Artículo 117 Bis de la Constitución Política del Estado de Jalisco', url: `${JALISCO_BASE}/Ley Reglamentaria del Artículo 117 Bis de la Constitución Política del Estado de Jalisco-310323.pdf` },
        { nombre: 'Ley Reglamentaria del Derecho de Vía en los Caminos Públicos de Jurisdicción Estatal', url: `${JALISCO_BASE}/Ley Reglamentaria del Derecho de Vía en los Caminos Públicos de Jurisdicción Estatal-310323.pdf` },
        ...
        { nombre: 'Ley de Amnistía', url: `${JALISCO_BASE}/Ley de Amnistía-150223.pdf` },
        { nombre: 'Ley de Amnistía para las Mujeres Víctimas de Violencia de Género.', url: `${JALISCO_BASE}/Ley de Amnistía para las Mujeres Víctimas de Violencia de Género.-091023.pdf` },
        ...
        { nombre: 'Ley de Atención a Víctimas del Estado de Jalisco', url: `${JALISCO_BASE}/Ley de Atención a Víctimas del Estado de Jalisco-251125.pdf` },
        ...
        { nombre: 'Ley de Beneméritos del Estado de Jalisco', url: `${JALISCO_BASE}/Ley de Beneméritos del Estado de Jalisco-220124.pdf` },
        ...
        { nombre: 'Ley de Ciencia, Desarrollo Tecnológico e Innovación del Estado de Jalisco', url: `${JALISCO_BASE}/Ley de Ciencia, Desarrollo Tecnológico e Innovación del Estado de Jalisco-250424.pdf` },
        { nombre: 'Ley de Compras Gubernamentales, Enajenaciones y Contratación de Servicios del Estado de Jalisco y sus Municipios', url: `${JALISCO_BASE}/Ley de Compras Gubernamentales, Enajenaciones y Contratación de Servicios del Estado de Jalisco y sus Municipios-171023.pdf` },
        ...
        { nombre: 'Ley de Coordinación Fiscal del Estado de Jalisco y sus Municipios', url: `${JALISCO_BASE}/Ley de Coordinación Fiscal del Estado de Jalisco y sus Municipios-130924.pdf` },
        { nombre: 'Ley de Coordinación Metropolitana del Estado de Jalisco', url: `${JALISCO_BASE}/Ley de Coordinación Metropolitana del Estado de Jalisco-200223.pdf` },
        { nombre: 'Ley de Cultura Física y Deporte del Estado de Jalisco', url: `${JALISCO_BASE}/Ley de Cultura Física y Deporte del Estado de Jalisco-140325.pdf` },
        ...
        { nombre: 'Ley de Deuda Pública y Disciplina Financiera del Estado de Jalisco y sus Municipios', url: `${JALISCO_BASE}/Ley de Deuda Pública y Disciplina Financiera del Estado de Jalisco y sus Municipios-290525.pdf` },
        { nombre: 'Ley de Educación Superior del Estado de Jalisco', url: `${JALISCO_BASE}/Ley de Educación Superior del Estado de Jalisco-170725.pdf` },
        { nombre: 'Ley de Educación del Estado Libre y Soberano de Jalisco', url: `${JALISCO_BASE}/Ley de Educación del Estado Libre y Soberano de Jalisco-121125.pdf` },
        ...
        { nombre: 'Ley de Entrega Recepción del Estado de Jalisco y sus Municipios', url: `${JALISCO_BASE}/Ley de Entrega Recepción del Estado de Jalisco y sus Municipios-160725.pdf` },
        { nombre: 'Ley de Evaluación y Supervisión de Medidas Cautelares y Suspensión Condicional del Proceso del Estado de Jalisco', url: `${JALISCO_BASE}/Ley de Evaluación y Supervisión de Medidas Cautelares y Suspensión Condicional del Proceso del Estado de Jalisco -210725.pdf` },
        { nombre: 'Ley de Expropiación de bienes Muebles e Inmuebles de Propiedad Privada', url: `${JALISCO_BASE}/Ley de Expropiación de bienes Muebles e Inmuebles de Propiedad Privada-190225.pdf` },
        { nombre: 'Ley de Filmaciones del Estado de Jalisco', url: `${JALISCO_BASE}/Ley de Filmaciones del Estado de Jalisco-230725.pdf` },
        { nombre: 'Ley de Firma Electrónica Avanzada para el Estado de Jalisco y sus Municipios', url: `${JALISCO_BASE}/Ley de Firma Electrónica Avanzada para el Estado de Jalisco y sus Municipios-250725.pdf` },
        { nombre: 'Ley de Fiscalización Superior y Rendición de Cuentas del Estado de Jalisco y sus Municipios', url: `${JALISCO_BASE}/Ley de Fiscalización Superior y Rendición de Cuentas del Estado de Jalisco y sus Municipios-200825.pdf` },
        { nombre: 'Ley de Fomento Apícola y Protección de Agentes Polinizadores de Jalisco', url: `${JALISCO_BASE}/Ley de Fomento Apícola y Protección de Agentes Polinizadores de Jalisco-270825.pdf` },
        ...
        { nombre: 'Ley de Gestión Integral de los Residuos del Estado de Jalisco', url: `${JALISCO_BASE}/Ley de Gestión Integral de los Residuos del Estado de Jalisco-030925.pdf` },
        ...
        { nombre: 'Ley de Incompatibilidades para los Servidores Públicos, Reglamentaria del Artículo 112 de la Constitución del Estado de Jalisco', url: `${JALISCO_BASE}/Ley de Incompatibilidades para los Servidores Públicos, Reglamentaria del Artículo 112 de la Constitución del Estado de Jalisco-220223.pdf` },
        ...
        { nombre: 'Ley de Límites Territoriales de los Municipios del Estado de Jalisco', url: `${JALISCO_BASE}/Ley de Límites Territoriales de los Municipios del Estado de Jalisco-240223.pdf` },
        ...
        { nombre: 'Ley de Nutrición Adecuada y Estilos de Vida Saludables del Estado de Jalisco', url: `${JALISCO_BASE}/Ley de Nutrición Adecuada y Estilos de Vida Saludables del Estado de Jalisco-220424.pdf` },
        { nombre: 'Ley de Obra Pública del Estado de Jalisco y sus Municipios', url: `${JALISCO_BASE}/Ley de Obra Pública del Estado de Jalisco y sus Municipios-180226.pdf` },
        ...
        { nombre: 'Ley de Planeación Participativa para el Estado de Jalisco y sus Municipios', url: `${JALISCO_BASE}/Ley de Planeación Participativa para el Estado de Jalisco y sus Municipios-230223.pdf` },
        { nombre: 'Ley de Prevención Social de la Violencia y la Delincuencia del Estado de Jalisco', url: `${JALISCO_BASE}/Ley de Prevención Social de la Violencia y la Delincuencia del Estado de Jalisco-230223.pdf` },
        { nombre: 'Ley de Promoción y Desarrollo Artesanal del Estado de Jalisco', url: `${JALISCO_BASE}/Ley de Promoción y Desarrollo Artesanal del Estado de Jalisco-240223.pdf` },
        { nombre: 'Ley de Protección Civil del Estado', url: `${JALISCO_BASE}/Ley de Protección Civil del Estado-091225.pdf` },
        { nombre: 'Ley de Protección contra la Exposición al Humo de Tabaco para el Estado de Jalisco', url: `${JALISCO_BASE}/Ley de Protección contra la Exposición al Humo de Tabaco para el Estado de Jalisco-240223.pdf` },
        { nombre: 'Ley de Protección de Datos Personales en Posesión de Sujetos Obligados del Estado de Jalisco y sus Municipios', url: `${JALISCO_BASE}/Ley de Protección de Datos Personales en Posesión de Sujetos Obligados del Estado de Jalisco y sus Municipios -240223.pdf` },
        { nombre: 'Ley de Protección y Atención de los Migrantes en el Estado de Jalisco', url: `${JALISCO_BASE}/Ley de Protección y Atención de los Migrantes en el Estado de Jalisco-111225.pdf` },
        { nombre: 'Ley de Protección y Cuidado de los Animales del Estado de Jalisco', url: `${JALISCO_BASE}/Ley de Protección y Cuidado de los Animales del Estado de Jalisco-250226.pdf` },
        { nombre: 'Ley de Protección, Conservación y Fomento de Arbolado y Áreas Verdes Urbanas del Estado de Jalisco y sus Municipios', url: `${JALISCO_BASE}/Ley de Protección, Conservación y Fomento de Arbolado y Áreas Verdes Urbanas del Estado de Jalisco y sus Municipios-240223.pdf` },
        { nombre: 'Ley de Proyectos de Inversión y de Prestación de Servicios del Estado de Jalisco y sus Municipios', url: `${JALISCO_BASE}/Ley de Proyectos de Inversión y de Prestación de Servicios del Estado de Jalisco y sus Municipios-240223.pdf` },
        ...
        { nombre: 'Ley de Responsabilidades Políticas y Administrativas del Estado de Jalisco', url: `${JALISCO_BASE}/Ley de Responsabilidades Políticas y Administrativas del Estado de Jalisco-170323.pdf` },
        ...
        { nombre: 'Ley de Transparencia y Acceso a la Información Pública del Estado de Jalisco y sus Municipios', url: `${JALISCO_BASE}/Ley de Transparencia y Acceso a la Información Pública del Estado de Jalisco y sus Municipios-180823.pdf` },
        ...
        { nombre: 'Ley de la Comisión Estatal de Derechos Humanos', url: `${JALISCO_BASE}/Ley de la Comisión Estatal de Derechos Humanos-211125.pdf` },
        { nombre: 'Ley de los Derechos de Niñas, Niños y Adolescentes en el Estado de Jalisco', url: `${JALISCO_BASE}/Ley de los Derechos de Niñas, Niños y Adolescentes en el Estado de Jalisco-281125.pdf` },
        ...
        { nombre: 'Ley de los Símbolos Oficiales del Estado de Jalisco', url: `${JALISCO_BASE}/Ley de los Símbolos Oficiales del Estado de Jalisco-011225.pdf` },
        ...
        { nombre: 'Ley del Centro de Atención para las Víctimas del Delito', url: `${JALISCO_BASE}/Ley del Centro de Atención para las Víctimas del Delito-270223.pdf` },
        { nombre: 'Ley del Gobierno y la Administración Pública Municipal del Estado de Jalisco', url: `${JALISCO_BASE}/Ley del Gobierno y la Administración Pública Municipal del Estado de Jalisco-080925.pdf` },
        ...
        { nombre: 'Ley del Organismo Público Descentralizado Hospital Civil de Guadalajara', url: `${JALISCO_BASE}/Ley del Organismo Público Descentralizado Hospital Civil de Guadalajara-280223.pdf` },
        { nombre: 'Ley del Organismo Público Descentralizado Servicios de Salud Jalisco', url: `${JALISCO_BASE}/Ley del Organismo Público Descentralizado Servicios de Salud Jalisco-190423.pdf` },
        { nombre: 'Ley del Organismo Público Descentralizado denominado Bosque la Primavera', url: `${JALISCO_BASE}/Ley del Organismo Público Descentralizado denominado Bosque la Primavera-280223.pdf` },
        { nombre: 'Ley del Periódico Oficial El Estado de Jalisco', url: `${JALISCO_BASE}/Ley del Periódico Oficial El Estado de Jalisco-280223.pdf` },
        { nombre: 'Ley del Presupuesto, Contabilidad  y Gasto Público del Estado de Jalisco', url: `${JALISCO_BASE}/Ley del Presupuesto, Contabilidad  y Gasto Público del Estado de Jalisco-161024.pdf` },
        ...
        { nombre: 'Ley del Registro Público de la Propiedad del Estado de Jalisco', url: `${JALISCO_BASE}/Ley del Registro Público de la Propiedad del Estado de Jalisco-280223.pdf` },
        ...
        { nombre: 'Ley del Servicio de Protección para el Estado de Jalisco y sus Municipios', url: `${JALISCO_BASE}/Ley del Servicio de Protección para el Estado de Jalisco y sus Municipios-181024.pdf` },
        { nombre: 'Ley del Sistema Anticorrupción del Estado de Jalisco', url: `${JALISCO_BASE}/Ley del Sistema Anticorrupción del Estado de Jalisco-150623.pdf` },
        ...
        { nombre: 'Ley del Sistema de Agua Potable y Alcantarillado de Ciudad Guzmán, Jalisco', url: `${JALISCO_BASE}/Ley del Sistema de Agua Potable y Alcantarillado de Ciudad Guzmán, Jalisco-010323.pdf` },
        ...
        { nombre: 'Ley del Sistema de Participación Ciudadana y Popular para la Gobernanza del Estado de Jalisco', url: `${JALISCO_BASE}/Ley del Sistema de Participación Ciudadana y Popular para la Gobernanza del Estado de Jalisco-010323.pdf` },
        { nombre: 'Ley del Sistema de Seguridad Pública para el Estado de Jalisco', url: `${JALISCO_BASE}/Ley del Sistema de Seguridad Pública para el Estado de Jalisco-150125.pdf` },
        { nombre: 'Ley para Garantizar el Derecho Humano a la Alimentación del Estado de Jalisco', url: `${JALISCO_BASE}/Ley para Garantizar el Derecho Humano a la Alimentación del Estado de Jalisco-190424.pdf` },
        ...
        { nombre: 'Ley para Regular la Venta y el Consumo de Bebidas Alcohólicas del Estado de Jalisco', url: `${JALISCO_BASE}/Ley para Regular la Venta y el Consumo de Bebidas Alcohólicas del Estado de Jalisco-040326.pdf` },
        { nombre: 'Ley para el Desarrollo Económico del Estado de Jalisco', url: `${JALISCO_BASE}/Ley para el Desarrollo Económico del Estado de Jalisco-120424.pdf` },
        ...
        { nombre: 'Ley para el Fomento y Participación de las Organizaciones de la Sociedad Civil en el Estado de Jalisco', url: `${JALISCO_BASE}/Ley para el Fomento y Participación de las Organizaciones de la Sociedad Civil en el Estado de Jalisco-270323.pdf` },
        { nombre: 'Ley para la Acción ante el Cambio Climático del Estado de Jalisco', url: `${JALISCO_BASE}/Ley para la Acción ante el Cambio Climático del Estado de Jalisco-270323.pdf` },
        { nombre: 'Ley para la Administración de Bienes Asegurados, Decomisados o Abandonados para el Estado de Jalisco', url: `${JALISCO_BASE}/Ley para la Administración de Bienes Asegurados, Decomisados o Abandonados para el Estado de Jalisco-280323.pdf` },
        { nombre: 'Ley para la Declaración Especial de Ausencia por Desaparición de Personas del Estado de Jalisco', url: `${JALISCO_BASE}/Ley para la Declaración Especial de Ausencia por Desaparición de Personas del Estado de Jalisco-100424.pdf` },
        { nombre: 'Ley para la Detección y Tratamiento Oportuno e Integral del Cáncer en la Infancia y en la Adolescencia del Estado de Jalisco', url: `${JALISCO_BASE}/Ley para la Detección y Tratamiento Oportuno e Integral del Cáncer en la Infancia y en la Adolescencia del Estado de Jalisco-141122.pdf` },
        { nombre: 'Ley para la Inclusión y Desarrollo Integral de las personas con Discapacidad del Estado de Jalisco', url: `${JALISCO_BASE}/Ley para la Inclusión y Desarrollo Integral de las personas con Discapacidad del Estado de Jalisco-230424.pdf` },
        { nombre: 'Ley para la Operación de Albergues del Estado de Jalisco', url: `${JALISCO_BASE}/Ley para la Operación de Albergues del Estado de Jalisco-290323.pdf` },
        { nombre: 'Ley para la Prevención y Atención de la Violencia Intrafamiliar del Estado de Jalisco', url: `${JALISCO_BASE}/Ley para la Prevención y Atención de la Violencia Intrafamiliar del Estado de Jalisco-290424.pdf` },
        { nombre: 'Ley para la Promoción de Inversiones en el Estado de Jalisco', url: `${JALISCO_BASE}/Ley para la Promoción de Inversiones en el Estado de Jalisco-171023.pdf` },
        { nombre: 'Ley para la Protección de Personas Defensoras de los Derechos Humanos y Periodistas del Estado de Jalisco', url: `${JALISCO_BASE}/Ley para la Protección de Personas Defensoras de los Derechos Humanos y Periodistas del Estado de Jalisco-180226.pdf` },
        { nombre: 'Ley para la Protección y Apoyo de las Madres Jefas de Familia del Estado de Jalisco', url: `${JALISCO_BASE}/Ley para la Protección y Apoyo de las Madres Jefas de Familia del Estado de Jalisco-290323.pdf` },
        { nombre: 'Ley para la Regularización y Titulación de Predios Urbanos en el Estado de Jalisco', url: `${JALISCO_BASE}/Ley para la Regularización y Titulación de Predios Urbanos en el Estado de Jalisco-290323.pdf` },
        ...
        { nombre: 'Ley para los Servidores Públicos del Estado de Jalisco y sus Municipios', url: `${JALISCO_BASE}/Ley para los Servidores Públicos del Estado de Jalisco y sus Municipios-130623.pdf` },
        { nombre: 'Ley que Crea el Organismo Público Descentralizado del Poder Ejecutivo denominado Sistema Intermunicipal de los Servicios de Agua Potable y Alcantarillado', url: `${JALISCO_BASE}/Ley que Crea el Organismo Público Descentralizado del Poder Ejecutivo denominado Sistema Intermunicipal de los Servicios de Agua Potable y Alcantarillado-210825.pdf` },
        ...
        { nombre: 'Ley que Establece el Registro y Acreditación de los Prestadores de Servicios en Materia Inmobiliaria del Estado de Jalisco', url: `${JALISCO_BASE}/Ley que Establece el Registro y Acreditación de los Prestadores de Servicios en Materia Inmobiliaria del Estado de Jalisco-180823.pdf` },
        { nombre: 'Ley que Establece la Remuneración de los Auxiliares en la Administración de la Justicia', url: `${JALISCO_BASE}/Ley que Establece la Remuneración de los Auxiliares en la Administración de la Justicia-310323.pdf` },
        ...
        { nombre: 'Ley que Regula los Centros de Atención Infantil en el Estado de Jalisco', url: `${JALISCO_BASE}/Ley que Regula los Centros de Atención Infantil en el Estado de Jalisco-310323.pdf` },
        { nombre: 'Ley que aprueba el Plan Parcial de Urbanización y Control de la Edificación para la Protección Ecológica de la Zona de Los Colomos', url: `${JALISCO_BASE}/Ley que aprueba el Plan Parcial de Urbanización y Control de la Edificación para la Protección Ecológica de la Zona de Los Colomos-310323.pdf` },
        ...
        { nombre: 'Ley que crea el Instituto de la Infraestructura Física Educativa del Estado de Jalisco', url: `${JALISCO_BASE}/Ley que crea el Instituto de la Infraestructura Física Educativa del Estado de Jalisco -290523.pdf` },
        ...
        { nombre: 'Ley que crea el Sistema de Agua Potable y Alcantarillado de Unión de Tula, Jalisco', url: `${JALISCO_BASE}/Ley que crea el Sistema de Agua Potable y Alcantarillado de Unión de Tula, Jalisco-310323.pdf` },
        { nombre: 'Ley que crea la Industria Jalisciense de Rehabilitación Social', url: `${JALISCO_BASE}/Ley que crea la Industria Jalisciense de Rehabilitación Social-310323.pdf` },
        { nombre: 'Ley que divide los Bienes Pertenecientes al Estado en Bienes de Dominio Público y Bienes de Dominio Privado', url: `${JALISCO_BASE}/Ley que divide los Bienes Pertenecientes al Estado en Bienes de Dominio Público y Bienes de Dominio Privado-310323.pdf` },
        ...
        { nombre: 'Ley sobre los Derechos y el Desarrollo de los Pueblos y las Comunidades Indígenas del Estado de Jalisco', url: `${JALISCO_BASE}/Ley sobre los Derechos y el Desarrollo de los Pueblos y las Comunidades Indígenas del Estado de Jalisco-310323.pdf` },
    ],
    codigos: [
        ...
        { nombre: 'Código Electoral del Estado de Jalisco', url: `${JALISCO_BASE}/Código Electoral del Estado de Jalisco-100725.pdf` },
        { nombre: 'Código Fiscal del Estado de Jalisco', url: `${JALISCO_BASE}/Código Fiscal del Estado de Jalisco-280524.pdf` },
        { nombre: 'Código Penal para el Estado Libre y Soberano de Jalisco', url: `${JALISCO_BASE}/Código Penal para el Estado Libre y Soberano de Jalisco -251125.pdf` },
        { nombre: 'Código Urbano para el Estado de Jalisco', url: `${JALISCO_BASE}/Código Urbano para el Estado de Jalisco-100823.pdf` },
    ],
    reglamentos: [],
    otros: [],
};
...
export const ESTADOS: Estado[] = [
    ...
    { slug: 'jalisco', nombre: 'Jalisco', nombreCorto: 'Jal.', abreviatura: 'JAL', region: 'occidente', leyesCount: 185, ultimaActualizacion: '2026-03-10', leyes: JALISCO_LEYES },
    { slug: 'estado-de-mexico', nombre: 'Estado de México', nombreCorto: 'EdoMéx', abreviatura: 'MEX', region: 'centro', leyesCount: 252, ultimaActualizacion: '2026-03-10', leyes: EDOMEX_LEYES },
