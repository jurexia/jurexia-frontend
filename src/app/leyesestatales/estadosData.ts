...
// --- Sinaloa: FULL DATA (149 leyes) --- PDFs hosted on Supabase -----

const SINALOA_BASE = 'https://ukcuzhwmmfwvcedvhfll.supabase.co/storage/v1/object/public/legal-docs/Sinaloa';

const SINALOA_LEYES: CategoriaLeyes = {
    constitucion: [
        { nombre: 'Constitución Política del Estado de Sinaloa', url: `${SINALOA_BASE}/Constitucion_Politica_del_Estado_de_Sinaloa.pdf` },
    ],
    leyes: [
        { nombre: 'Ley Ambiental para el Desarrollo Sustentable', url: `${SINALOA_BASE}/Ley_Ambiental_para_el_Desarrollo_Sustentable.pdf` },
        { nombre: 'Ley de Acceso de las Mujeres a una Vida Libre de Violencia', url: `${SINALOA_BASE}/Ley_de_Acceso_de_las_Mujeres_a_una_Vida_Libre_de_Violencia.pdf` },
        { nombre: 'Ley de Adquisiciones, Arrendamientos, Servicios y Administración de Bienes Muebles', url: `${SINALOA_BASE}/Ley_de_Adquisiciones__Arrendamientos__Servicios_y_Administracion_de_Bienes_Muebles.pdf` },
        { nombre: 'Ley de Agua Potable y Alcantarillado', url: `${SINALOA_BASE}/Ley_de_Agua_Potable_y_Alcantarillado.pdf` },
        { nombre: 'Ley de Amnistía', url: `${SINALOA_BASE}/Ley_de_Amnistia.pdf` },
        { nombre: 'Ley de Aranceles', url: `${SINALOA_BASE}/Ley_de_Aranceles.pdf` },
        { nombre: 'Ley de Aranceles para los Abogados', url: `${SINALOA_BASE}/Ley_de_Aranceles_para_los_Abogados.pdf` },
        { nombre: 'Ley de Archivos', url: `${SINALOA_BASE}/Ley_de_Archivos.pdf` },
        { nombre: 'Ley de Atención y Protección a Víctimas', url: `${SINALOA_BASE}/Ley_de_Atencion_y_Proteccion_a_Victimas.pdf` },
        { nombre: 'Ley de Austeridad', url: `${SINALOA_BASE}/Ley_de_Austeridad.pdf` },
        { nombre: 'Ley de Bibliotecas', url: `${SINALOA_BASE}/Ley_de_Bibliotecas.pdf` },
        { nombre: 'Ley de Catastro', url: `${SINALOA_BASE}/Ley_de_Catastro.pdf` },
        { nombre: 'Ley de Ciencia, Tecnología e Innovación', url: `${SINALOA_BASE}/Ley_de_Ciencia__Tecnologia_e_Innovacion.pdf` },
        { nombre: 'Ley de Contratos de Colaboración Público Privada', url: `${SINALOA_BASE}/Ley_de_Contratos_de_Colaboracion_Publico_Privada.pdf` },
        { nombre: 'Ley de Coordinación de Sanidad e Inocuidad Agrícola', url: `${SINALOA_BASE}/Ley_de_Coordinacion_de_Sanidad_e_Inocuidad_Agricola.pdf` },
        { nombre: 'Ley de Coordinación Fiscal', url: `${SINALOA_BASE}/Ley_de_Coordinacion_Fiscal.pdf` },
        { nombre: 'Ley de Cultura', url: `${SINALOA_BASE}/Ley_de_Cultura.pdf` },
        { nombre: 'Ley de Cultura Física y Deporte', url: `${SINALOA_BASE}/Ley_de_Cultura_Fisica_y_Deporte.pdf` },
        { nombre: 'Ley de Desarrollo Forestal Sustentable', url: `${SINALOA_BASE}/Ley_de_Desarrollo_Forestal_Sustentable.pdf` },
        { nombre: 'Ley de Desarrollo Ganadero', url: `${SINALOA_BASE}/Ley_de_Desarrollo_Ganadero.pdf` },
        { nombre: 'Ley de desarrollo rural sustentable', url: `${SINALOA_BASE}/Ley_de_desarrollo_rural_sustentable.pdf` },
        { nombre: 'Ley de Deuda Pública', url: `${SINALOA_BASE}/Ley_de_Deuda_Publica.pdf` },
        { nombre: 'Ley de Educación', url: `${SINALOA_BASE}/Ley_de_Educacion.pdf` },
        { nombre: 'Ley de Educación Superior', url: `${SINALOA_BASE}/Ley_de_Educacion_Superior.pdf` },
        { nombre: 'Ley de Ejecución de las Consecuencias Jurídicas del Delito', url: `${SINALOA_BASE}/Ley_de_Ejecucion_de_las_Consecuencias_Juridicas_del_Delito.pdf` },
        { nombre: 'Ley de Entidades Paraestatales', url: `${SINALOA_BASE}/Ley_de_Entidades_Paraestatales.pdf` },
        { nombre: 'Ley de Entrega y Recepción de los Asuntos y Recursos Públicos', url: `${SINALOA_BASE}/Ley_de_Entrega_y_Recepcion_de_los_Asuntos_y_Recursos_Publicos.pdf` },
        { nombre: 'Ley de Extinción de Dominio', url: `${SINALOA_BASE}/Ley_de_Extincion_de_Dominio.pdf` },
        { nombre: 'Ley de Fomento a la Inversión para el Desarrollo Económico', url: `${SINALOA_BASE}/Ley_de_Fomento_a_la_Inversion_para_el_Desarrollo_Economico.pdf` },
        { nombre: 'Ley de Fomento a la Lectura y el Libro', url: `${SINALOA_BASE}/Ley_de_Fomento_a_la_Lectura_y_el_Libro.pdf` },
        { nombre: 'Ley de Fomento Apícola y Protección de Agentes Polinizadores', url: `${SINALOA_BASE}/Ley_de_Fomento_Apicola_y_Proteccion_de_Agentes_Polinizadores.pdf` },
        { nombre: 'Ley de Fomento de Valores, Formación Cívica y Cultura de la Legalidad', url: `${SINALOA_BASE}/Ley_de_Fomento_de_Valores__Formacion_Civica_y_Cultura_de_la_Legalidad.pdf` },
        { nombre: 'Ley de Fomento Minero', url: `${SINALOA_BASE}/Ley_de_Fomento_Minero.pdf` },
        { nombre: 'Ley de Fomento para el Desarrollo Económico de Madres Jefas de Familia', url: `${SINALOA_BASE}/Ley_de_Fomento_para_el_Desarrollo_Economico_de_Madres_Jefas_de_Familia.pdf` },
        { nombre: 'Ley de Fomento y Protección del Maíz Nativo', url: `${SINALOA_BASE}/Ley_de_Fomento_y_Proteccion_del_Maiz_Nativo.pdf` },
        { nombre: 'Ley de Gobierno Electrónico', url: `${SINALOA_BASE}/Ley_de_Gobierno_Electronico.pdf` },
        { nombre: 'Ley de Gobierno Municipal', url: `${SINALOA_BASE}/Ley_de_Gobierno_Municipal.pdf` },
        { nombre: 'Ley de Hacienda', url: `${SINALOA_BASE}/Ley_de_Hacienda.pdf` },
        { nombre: 'Ley de Hacienda Municipal', url: `${SINALOA_BASE}/Ley_de_Hacienda_Municipal.pdf` },
        { nombre: 'Ley de Instituciones de Asistencia Privada', url: `${SINALOA_BASE}/Ley_de_Instituciones_de_Asistencia_Privada.pdf` },
        { nombre: 'Ley de Instituciones y Procedimientos Electorales', url: `${SINALOA_BASE}/Ley_de_Instituciones_y_Procedimientos_Electorales.pdf` },
        { nombre: 'Ley de Integración Social de Personas con Discapacidad', url: `${SINALOA_BASE}/Ley_de_Integracion_Social_de_Personas_con_Discapacidad.pdf` },
        { nombre: 'Ley de Justicia Administrativa', url: `${SINALOA_BASE}/Ley_de_Justicia_Administrativa.pdf` },
        { nombre: 'Ley de la Auditoría Superior del Estado de Sinaloa', url: `${SINALOA_BASE}/Ley_de_la_Auditoria_Superior_del_Estado_de_Sinaloa.pdf` },
        { nombre: 'Ley de la Defensoría Pública', url: `${SINALOA_BASE}/Ley_de_la_Defensoria_Publica.pdf` },
        { nombre: 'Ley de la Juventud', url: `${SINALOA_BASE}/Ley_de_la_Juventud.pdf` },
        { nombre: 'Ley de los Comités Locales de Caminos Vecinales', url: `${SINALOA_BASE}/Ley_de_los_Comites_Locales_de_Caminos_Vecinales.pdf` },
        { nombre: 'Ley de los Derechos de las Personas Adultas Mayores', url: `${SINALOA_BASE}/Ley_de_los_Derechos_de_las_Personas_Adultas_Mayores.pdf` },
        { nombre: 'Ley de los Derechos de los Pueblos y Comunidades Indígenas', url: `${SINALOA_BASE}/Ley_de_los_Derechos_de_los_Pueblos_y_Comunidades_Indigenas.pdf` },
        { nombre: 'Ley de los Derechos de Niñas, Niños y Adolescentes', url: `${SINALOA_BASE}/Ley_de_los_Derechos_de_Ninas__Ninos_y_Adolescentes.pdf` },
        { nombre: 'Ley de los Trabajadores al Servicio de los Municipios', url: `${SINALOA_BASE}/Ley_de_los_Trabajadores_al_Servicio_de_los_Municipios.pdf` },
        { nombre: 'Ley de los Trabajadores al Servicio del Estado de Sinaloa', url: `${SINALOA_BASE}/Ley_de_los_Trabajadores_al_Servicio_del_Estado_de_Sinaloa.pdf` },
        { nombre: 'Ley de Mecanismos Alternativos de Solución de Controversias', url: `${SINALOA_BASE}/Ley_de_Mecanismos_Alternativos_de_Solucion_de_Controversias.pdf` },
        { nombre: 'Ley de Mejora Regulatoria y Gestión Empresarial', url: `${SINALOA_BASE}/Ley_de_Mejora_Regulatoria_y_Gestion_Empresarial.pdf` },
        { nombre: 'Ley de Movilidad Sustentable y Seguridad Vial', url: `${SINALOA_BASE}/Ley_de_Movilidad_Sustentable_y_Seguridad_Vial.pdf` },
        { nombre: 'Ley de Obras Públicas y Servicios Relacionados con las Mismas', url: `${SINALOA_BASE}/Ley_de_Obras_Publicas_y_Servicios_Relacionados_con_las_Mismas.pdf` },
        { nombre: 'Ley de Ordenamiento Territorial y Desarrollo Urbano', url: `${SINALOA_BASE}/Ley_de_Ordenamiento_Territorial_y_Desarrollo_Urbano.pdf` },
        { nombre: 'Ley de Organizaciones Agrícolas', url: `${SINALOA_BASE}/Ley_de_Organizaciones_Agricolas.pdf` },
        { nombre: 'Ley de Participación Ciudadana', url: `${SINALOA_BASE}/Ley_de_Participacion_Ciudadana.pdf` },
        { nombre: 'Ley de Pensiones', url: `${SINALOA_BASE}/Ley_de_Pensiones.pdf` },
        { nombre: 'Ley de Pesca y Acuacultura Sustentables', url: `${SINALOA_BASE}/Ley_de_Pesca_y_Acuacultura_Sustentables.pdf` },
        { nombre: 'Ley de Planeación', url: `${SINALOA_BASE}/Ley_de_Planeacion.pdf` },
        { nombre: 'Ley de Prestación de Servicios Inmobiliarios', url: `${SINALOA_BASE}/Ley_de_Prestacion_de_Servicios_Inmobiliarios.pdf` },
        { nombre: 'Ley de prestación de servicios para la atención, cuidado y desarrollo integral infantil', url: `${SINALOA_BASE}/Ley_de_prestacion_de_servicios_para_la_atencion__cuidado_y_desarrollo_integral_infantil.pdf` },
        { nombre: 'Ley de Presupuesto y Responsabilidad Hacendaria', url: `${SINALOA_BASE}/Ley_de_Presupuesto_y_Responsabilidad_Hacendaria.pdf` },
        { nombre: 'Ley de Profesiones', url: `${SINALOA_BASE}/Ley_de_Profesiones.pdf` },
        { nombre: 'Ley de Protección a los Animales', url: `${SINALOA_BASE}/Ley_de_Proteccion_a_los_Animales.pdf` },
        { nombre: 'Ley de Protección Civil', url: `${SINALOA_BASE}/Ley_de_Proteccion_Civil.pdf` },
        { nombre: 'Ley de Protección de Datos Personales en Posesión de Sujetos Obligados', url: `${SINALOA_BASE}/Ley_de_Proteccion_de_Datos_Personales_en_Posesion_de_Sujetos_Obligados.pdf` },
        { nombre: 'Ley de Regularización de Predios Rurales', url: `${SINALOA_BASE}/Ley_de_Regularizacion_de_Predios_Rurales.pdf` },
        { nombre: 'Ley de Remuneraciones de los Servidores Públicos', url: `${SINALOA_BASE}/Ley_de_Remuneraciones_de_los_Servidores_Publicos.pdf` },
        { nombre: 'Ley de Residuos', url: `${SINALOA_BASE}/Ley_de_Residuos.pdf` },
        { nombre: 'Ley de Responsabilidad Patrimonial para el Estado de Sinaloa y sus Municipios', url: `${SINALOA_BASE}/Ley_de_Responsabilidad_Patrimonial_para_el_Estado_de_Sinaloa_y_sus_Municipios.pdf` },
        { nombre: 'Ley de Responsabilidades Administrativas', url: `${SINALOA_BASE}/Ley_de_Responsabilidades_Administrativas.pdf` },
        { nombre: 'Ley de Responsabilidades de los Servidores Públicos', url: `${SINALOA_BASE}/Ley_de_Responsabilidades_de_los_Servidores_Publicos.pdf` },
        { nombre: 'Ley de Revocación de Mandato', url: `${SINALOA_BASE}/Ley_de_Revocacion_de_Mandato.pdf` },
        { nombre: 'Ley de Salud', url: `${SINALOA_BASE}/Ley_de_Salud.pdf` },
        { nombre: 'Ley de Salud Mental', url: `${SINALOA_BASE}/Ley_de_Salud_Mental.pdf` },
        { nombre: 'Ley de Seguridad Pública', url: `${SINALOA_BASE}/Ley_de_Seguridad_Publica.pdf` },
        { nombre: 'Ley de Sociedades Mutualistas', url: `${SINALOA_BASE}/Ley_de_Sociedades_Mutualistas.pdf` },
        { nombre: 'Ley de Transparencia y Acceso a la Información Pública', url: `${SINALOA_BASE}/Ley_de_Transparencia_y_Acceso_a_la_Informacion_Publica.pdf` },
        { nombre: 'Ley de Vivienda', url: `${SINALOA_BASE}/Ley_de_Vivienda.pdf` },
        { nombre: 'Ley del Instituto de Evaluación Educativa', url: `${SINALOA_BASE}/Ley_del_Instituto_de_Evaluacion_Educativa.pdf` },
        { nombre: 'Ley del Mérito Social del Estado de Sinaloa', url: `${SINALOA_BASE}/Ley_del_Merito_Social_del_Estado_de_Sinaloa.pdf` },
        { nombre: 'Ley del Notariado del Estado de Sinaloa', url: `${SINALOA_BASE}/Ley_del_Notariado_del_Estado_de_Sinaloa.pdf` },
        { nombre: 'Ley del Servicio de Administración Tributaria', url: `${SINALOA_BASE}/Ley_del_Servicio_de_Administracion_Tributaria.pdf` },
        { nombre: 'Ley del Sistema Anticorrupción', url: `${SINALOA_BASE}/Ley_del_Sistema_Anticorrupcion.pdf` },
        { nombre: 'Ley del Sistema de Medios de Impugnación en Materia Electoral y de Participación Ciudadana', url: `${SINALOA_BASE}/Ley_del_Sistema_de_Medios_de_Impugnacion_en_Materia_Electoral_y_de_Participacion_Ciudadana.pdf` },
        { nombre: 'Ley en Materia de Desaparición Forzada de Personas, Desaparición Cometida por Particulares y del Sistema Estatal de Búsqueda de Personas de Sinaloa', url: `${SINALOA_BASE}/Ley_en_Materia_de_Desaparicion_Forzada_de_Personas__Desaparicion_Cometida_por_Particulares_y_del_Sistema_Estatal_de_Busq.pdf` },
        { nombre: 'Ley Estatal de Cambio Climático', url: `${SINALOA_BASE}/Ley_Estatal_de_Cambio_Climatico.pdf` },
        { nombre: 'Ley Orgánica de la Administración Pública', url: `${SINALOA_BASE}/Ley_Organica_de_la_Administracion_Publica.pdf` },
        { nombre: 'Ley Orgánica de la Comisión Estatal de Derechos Humanos', url: `${SINALOA_BASE}/Ley_Organica_de_la_Comision_Estatal_de_Derechos_Humanos.pdf` },
        { nombre: 'Ley Orgánica de la Fiscalía General', url: `${SINALOA_BASE}/Ley_Organica_de_la_Fiscalia_General.pdf` },
        { nombre: 'Ley Orgánica de la Procuraduría Fiscal', url: `${SINALOA_BASE}/Ley_Organica_de_la_Procuraduria_Fiscal.pdf` },
        { nombre: 'Ley Orgánica de la Universidad Autónoma de Occidente', url: `${SINALOA_BASE}/Ley_Organica_de_la_Universidad_Autonoma_de_Occidente.pdf` },
        { nombre: 'Ley Orgánica de la Universidad Autónoma de Sinaloa', url: `${SINALOA_BASE}/Ley_Organica_de_la_Universidad_Autonoma_de_Sinaloa.pdf` },
        { nombre: 'Ley Orgánica de la Universidad Autónoma Indígena de México', url: `${SINALOA_BASE}/Ley_Organica_de_la_Universidad_Autonoma_Indigena_de_Mexico.pdf` },
        { nombre: 'Ley Orgánica de la Universidad de la Policía', url: `${SINALOA_BASE}/Ley_Organica_de_la_Universidad_de_la_Policia.pdf` },
        { nombre: 'Ley Orgánica de la Universidad Pedagógica del Estado de Sinaloa', url: `${SINALOA_BASE}/Ley_Organica_de_la_Universidad_Pedagogica_del_Estado_de_Sinaloa.pdf` },
        { nombre: 'Ley Orgánica del Centro de Conciliación Laboral', url: `${SINALOA_BASE}/Ley_Organica_del_Centro_de_Conciliacion_Laboral.pdf` },
        { nombre: 'Ley Orgánica del Congreso del Estado de Sinaloa', url: `${SINALOA_BASE}/Ley_Organica_del_Congreso_del_Estado_de_Sinaloa.pdf` },
        { nombre: 'Ley Orgánica del Fondo Auxiliar para la Administración de Justicia', url: `${SINALOA_BASE}/Ley_Organica_del_Fondo_Auxiliar_para_la_Administracion_de_Justicia.pdf` },
        { nombre: 'Ley Orgánica del Poder Judicial', url: `${SINALOA_BASE}/Ley_Organica_del_Poder_Judicial.pdf` },
        { nombre: 'Ley Orgánica del Tribunal de Justicia Administrativa del Estado de Sinaloa', url: `${SINALOA_BASE}/Ley_Organica_del_Tribunal_de_Justicia_Administrativa_del_Estado_de_Sinaloa.pdf` },
        { nombre: 'Ley para el Aprovechamiento Integral de Alimentos y su Donación Altruista', url: `${SINALOA_BASE}/Ley_para_el_Aprovechamiento_Integral_de_Alimentos_y_su_Donacion_Altruista.pdf` },
        { nombre: 'Ley para el Desarrollo de la Competitividad de las Micro, Pequeñas y Medianas Empresas', url: `${SINALOA_BASE}/Ley_para_el_Desarrollo_de_la_Competitividad_de_las_Micro__Pequenas_y_Medianas_Empresas.pdf` },
        { nombre: 'Ley para el Fomento de la Actividad Artesanal', url: `${SINALOA_BASE}/Ley_para_el_Fomento_de_la_Actividad_Artesanal.pdf` },
        { nombre: 'Ley para el Fomento del Turismo', url: `${SINALOA_BASE}/Ley_para_el_Fomento_del_Turismo.pdf` },
        { nombre: 'Ley para Impulsar la Productividad y Competitividad de la Economía', url: `${SINALOA_BASE}/Ley_para_Impulsar_la_Productividad_y_Competitividad_de_la_Economia.pdf` },
        { nombre: 'Ley para la Administración de Bienes Asegurados, Decomisados o Abandonados', url: `${SINALOA_BASE}/Ley_para_la_Administracion_de_Bienes_Asegurados__Decomisados_o_Abandonados.pdf` },
        { nombre: 'Ley para la Atención y Protección a Personas con la Condición del Espectro Autista', url: `${SINALOA_BASE}/Ley_para_la_Atencion_y_Proteccion_a_Personas_con_la_Condicion_del_Espectro_Autista.pdf` },
        { nombre: 'Ley para la Detección Oportuna del Cáncer en la Infancia y la Adolescencia', url: `${SINALOA_BASE}/Ley_para_la_Deteccion_Oportuna_del_Cancer_en_la_Infancia_y_la_Adolescencia.pdf` },
        { nombre: 'Ley para la Dotación Gratuita de Uniformes, Calzado Deportivo y Útiles Escolares', url: `${SINALOA_BASE}/Ley_para_la_Dotacion_Gratuita_de_Uniformes__Calzado_Deportivo_y_Utiles_Escolares.pdf` },
        { nombre: 'Ley para la Igualdad entre Mujeres y Hombres', url: `${SINALOA_BASE}/Ley_para_la_Igualdad_entre_Mujeres_y_Hombres.pdf` },
        { nombre: 'Ley para la Prevención Social de la Violencia y la Delincuencia, con Participación Ciudadana', url: `${SINALOA_BASE}/Ley_para_la_Prevencion_Social_de_la_Violencia_y_la_Delincuencia__con_Participacion_Ciudadana.pdf` },
        { nombre: 'Ley para la Prevención y Atención de la Violencia Familiar', url: `${SINALOA_BASE}/Ley_para_la_Prevencion_y_Atencion_de_la_Violencia_Familiar.pdf` },
        { nombre: 'Ley para la Promoción y Desarrollo de los Jóvenes Emprendedores', url: `${SINALOA_BASE}/Ley_para_la_Promocion_y_Desarrollo_de_los_Jovenes_Emprendedores.pdf` },
        { nombre: 'Ley para la Protección de Personas Defensoras de Derechos Humanos y Periodistas', url: `${SINALOA_BASE}/Ley_para_la_Proteccion_de_Personas_Defensoras_de_Derechos_Humanos_y_Periodistas.pdf` },
        { nombre: 'Ley para la Protección de Personas que Intervienen en el Procedimiento Penal', url: `${SINALOA_BASE}/Ley_para_la_Proteccion_de_Personas_que_Intervienen_en_el_Procedimiento_Penal.pdf` },
        { nombre: 'Ley para la Protección, Apoyo y Promoción a la Lactancia Materna', url: `${SINALOA_BASE}/Ley_para_la_Proteccion__Apoyo_y_Promocion_a_la_Lactancia_Materna.pdf` },
        { nombre: 'Ley para la Protección, Atención y Asistencia a las Víctimas de los Delitos en Materia de Trata de Personas', url: `${SINALOA_BASE}/Ley_para_la_Proteccion__Atencion_y_Asistencia_a_las_Victimas_de_los_Delitos_en_Materia_de_Trata_de_Personas.pdf` },
        { nombre: 'Ley para Prevenir y Eliminar la Discriminación', url: `${SINALOA_BASE}/Ley_para_Prevenir_y_Eliminar_la_Discriminacion.pdf` },
        { nombre: 'Ley para Prevenir, Atender y Erradicar la Violencia Escolar', url: `${SINALOA_BASE}/Ley_para_Prevenir__Atender_y_Erradicar_la_Violencia_Escolar.pdf` },
        { nombre: 'Ley para Prevenir, Atender y Reparar Integralmente el Desplazamiento Forzado Interno', url: `${SINALOA_BASE}/Ley_para_Prevenir__Atender_y_Reparar_Integralmente_el_Desplazamiento_Forzado_Interno.pdf` },
        { nombre: 'Ley para Prevenir, Investigar y Sancionar la Tortura y Otros Tratos o Penas Crueles, Inhumanos o Degradantes', url: `${SINALOA_BASE}/Ley_para_Prevenir__Investigar_y_Sancionar_la_Tortura_y_Otros_Tratos_o_Penas_Crueles__Inhumanos_o_Degradantes.pdf` },
        { nombre: 'Ley por las que se establece el Fondo para la Dotación y Mantenimiento de Equipo y Programas de Cómputo a los Planteles de Educación Pública Básica', url: `${SINALOA_BASE}/Ley_por_las_que_se_establece_el_Fondo_para_la_Dotacion_y_Mantenimiento_de_Equipo_y_Programas_de_Computo_a_los_Planteles_.pdf` },
        { nombre: 'Ley que crea el Instituto de Seguridad y Servicios Sociales de los Trabajadores de la Educación', url: `${SINALOA_BASE}/Ley_que_crea_el_Instituto_de_Seguridad_y_Servicios_Sociales_de_los_Trabajadores_de_la_Educacion.pdf` },
        { nombre: 'Ley que crea la Institución Pública descentralizada Viveros de Sinaloa', url: `${SINALOA_BASE}/Ley_que_crea_la_Institucion_Publica_descentralizada_Viveros_de_Sinaloa.pdf` },
        { nombre: 'Ley que Establece el Catálogo de Pueblos y Comunidades Indígenas', url: `${SINALOA_BASE}/Ley_que_Establece_el_Catalogo_de_Pueblos_y_Comunidades_Indigenas.pdf` },
        { nombre: 'Ley que Establece el Derecho de Vía de las Carreteras y Caminos Locales', url: `${SINALOA_BASE}/Ley_que_Establece_el_Derecho_de_Via_de_las_Carreteras_y_Caminos_Locales.pdf` },
        { nombre: 'Ley que establece las Bases Normativas para la Expedición de los Bandos de Policía y Gobierno', url: `${SINALOA_BASE}/Ley_que_establece_las_Bases_Normativas_para_la_Expedicion_de_los_Bandos_de_Policia_y_Gobierno.pdf` },
        { nombre: 'Ley que Protege la Salud y los Derechos de los No Fumadores', url: `${SINALOA_BASE}/Ley_que_Protege_la_Salud_y_los_Derechos_de_los_No_Fumadores.pdf` },
        { nombre: 'Ley que Regula el Aseguramiento, Administración, Enajenación y Disposición Final de Vehículos Automotores, Accesorios o Componentes Abandonados', url: `${SINALOA_BASE}/Ley_que_Regula_el_Aseguramiento__Administracion__Enajenacion_y_Disposicion_Final_de_Vehiculos_Automotores__Accesorios_o_.pdf` },
        { nombre: 'Ley que Regula la Prevención y el Control de las Adicciones', url: `${SINALOA_BASE}/Ley_que_Regula_la_Prevencion_y_el_Control_de_las_Adicciones.pdf` },
        { nombre: 'Ley que Regula las Casas de Empeño', url: `${SINALOA_BASE}/Ley_que_Regula_las_Casas_de_Empeno.pdf` },
        { nombre: 'Ley Reglamentaria de la Fracción III, del Artículo 104 de la Constitución Política', url: `${SINALOA_BASE}/Ley_Reglamentaria_de_la_Fraccion_III__del_Articulo_104_de_la_Constitucion_Politica.pdf` },
        { nombre: 'Ley Reglamentaria del Artículo 154 Reformado de la Constitución Política del Estado', url: `${SINALOA_BASE}/Ley_Reglamentaria_del_Articulo_154_Reformado_de_la_Constitucion_Politica_del_Estado.pdf` },
        { nombre: 'Ley sobre el Régimen de Propiedad en Condominio de Inmuebles', url: `${SINALOA_BASE}/Ley_sobre_el_Regimen_de_Propiedad_en_Condominio_de_Inmuebles.pdf` },
        { nombre: 'Ley sobre el Sistema Estatal de Asistencia Social', url: `${SINALOA_BASE}/Ley_sobre_el_Sistema_Estatal_de_Asistencia_Social.pdf` },
        { nombre: 'Ley sobre Inmuebles del Estado y Municipios', url: `${SINALOA_BASE}/Ley_sobre_Inmuebles_del_Estado_y_Municipios.pdf` },
        { nombre: 'Ley sobre Operación y Funcionamiento de Establecimientos Destinados a la Producción, Distribución, Venta y Consumo de Bebidas Alcohólicas', url: `${SINALOA_BASE}/Ley_sobre_Operacion_y_Funcionamiento_de_Establecimientos_Destinados_a_la_Produccion__Distribucion__Venta_y_Consumo_de_Be.pdf` },
    ],
    codigos: [
        { nombre: 'Código Civil', url: `${SINALOA_BASE}/Codigo_Civil.pdf` },
        { nombre: 'Código de Procedimientos Civiles', url: `${SINALOA_BASE}/Codigo_de_Procedimientos_Civiles.pdf` },
        { nombre: 'Código de Procedimientos Familiares', url: `${SINALOA_BASE}/Codigo_de_Procedimientos_Familiares.pdf` },
        { nombre: 'Código Familiar', url: `${SINALOA_BASE}/Codigo_Familiar.pdf` },
        { nombre: 'Código Fiscal', url: `${SINALOA_BASE}/Codigo_Fiscal.pdf` },
        { nombre: 'Código Fiscal Municipal', url: `${SINALOA_BASE}/Codigo_Fiscal_Municipal.pdf` },
        { nombre: 'Código Penal', url: `${SINALOA_BASE}/Codigo_Penal.pdf` },
    ],
    reglamentos: [],
    otros: [],
};
...
export const ESTADOS: Estado[] = [
    { slug: 'aguascalientes', nombre: 'Aguascalientes', nombreCorto: 'Aguascalientes', abreviatura: 'AGS', region: 'centro', leyesCount: 9, leyes: {
      constitucion: [],
      codigos: [],
      reglamentos: [],
      otros: [],
      leyes: [
        { nombre: 'Código Civil del Estado de Aguascalientes', url: 'https://storage.googleapis.com/iurexia-leyes/aguascalientes/C%C3%B3digo%20Civil%20del%20Estado%20de%20Aguascalientes.pdf' },
        { nombre: 'código de Proceimientos Civiles del Estado de Aguascalientes', url: 'https://storage.googleapis.com/iurexia-leyes/aguascalientes/c%C3%B3digo%20de%20Proceimientos%20Civiles%20del%20Estado%20de%20Aguascalientes.pdf' },
        { nombre: 'Código Fiscal del Estado de Aguascalientes', url: 'https://storage.googleapis.com/iurexia-leyes/aguascalientes/C%C3%B3digo%20Fiscal%20del%20Estado%20de%20Aguascalientes.pdf' },
        { nombre: 'Código Penal para el Estado de Aguascalientes', url: 'https://storage.googleapis.com/iurexia-leyes/aguascalientes/C%C3%B3digo%20Penal%20para%20el%20Estado%20de%20Aguascalientes.pdf' },
        { nombre: 'LEY DE HACIENDA DEL MUNICIPIO DE AGUASCALIENTES, AGUASCALIENTES', url: 'https://storage.googleapis.com/iurexia-leyes/aguascalientes/LEY%20DE%20HACIENDA%20DEL%20MUNICIPIO%20DE%20AGUASCALIENTES%2C%20AGUASCALIENTES.pdf' },
        { nombre: 'Ley de Responsabilidad Patrimonial del Estado de Aguascalientes', url: 'https://storage.googleapis.com/iurexia-leyes/aguascalientes/Ley%20de%20Responsabilidad%20Patrimonial%20del%20Estado%20de%20Aguascalientes.pdf' },
        { nombre: 'Ley de Responsabilidades Administrativas del Estado de Aguascalientes', url: 'https://storage.googleapis.com/iurexia-leyes/aguascalientes/Ley%20de%20Responsabilidades%20Administrativas%20del%20Estado%20de%20Aguascalientes.pdf' },
        { nombre: 'Ley del Procedimiento Administrativo del Estado de Aguascalientes', url: 'https://storage.googleapis.com/iurexia-leyes/aguascalientes/Ley%20del%20Procedimiento%20Administrativo%20del%20Estado%20de%20Aguascalientes.pdf' },
        { nombre: 'Ley del Procedimiento Contencioso Administrativo para el Estado de Aguascalientes', url: 'https://storage.googleapis.com/iurexia-leyes/aguascalientes/Ley%20del%20Procedimiento%20Contencioso%20Administrativo%20para%20el%20Estado%20de%20Aguascalientes.pdf' },
      ]
    } },
    { slug: 'baja-california', nombre: 'Baja California', nombreCorto: 'Baja California', abreviatura: 'BC', region: 'norte', leyesCount: 8, leyes: {
      constitucion: [],
      codigos: [],
      reglamentos: [],
      otros: [],
      leyes: [
        { nombre: 'Código Civil para el Estado de Baja California', url: 'https://storage.googleapis.com/iurexia-leyes/bajacalifornia/C%C3%B3digo%20Civil%20para%20el%20Estado%20de%20Baja%20California.pdf' },
        { nombre: 'Código de Procedimientos Civiles para el Estado de Baja California', url: 'https://storage.googleapis.com/iurexia-leyes/bajacalifornia/C%C3%B3digo%20de%20Procedimientos%20Civiles%20para%20el%20Estado%20de%20Baja%20California.pdf' },
        { nombre: 'Código Fiscal del Estado de Baja California', url: 'https://storage.googleapis.com/iurexia-leyes/bajacalifornia/C%C3%B3digo%20Fiscal%20del%20Estado%20de%20Baja%20California.pdf' },
        { nombre: 'Código Penal para el Estado de Baja California', url: 'https://storage.googleapis.com/iurexia-leyes/bajacalifornia/C%C3%B3digo%20Penal%20para%20el%20Estado%20de%20Baja%20California.pdf' },
        { nombre: 'Ley de Acceso de las Mujeres a una Vida Libre de Violencia para el Estado de Baja California', url: 'https://storage.googleapis.com/iurexia-leyes/bajacalifornia/Ley%20de%20Acceso%20de%20las%20Mujeres%20a%20una%20Vida%20Libre%20de%20Violencia%20para%20el%20Estado%20de%20Baja%20California.pdf' },
        { nombre: 'Ley de Movilidad Sustentable y Transporte del Estado de Baja California', url: 'https://storage.googleapis.com/iurexia-leyes/bajacalifornia/Ley%20de%20Movilidad%20Sustentable%20y%20Transporte%20del%20Estado%20de%20Baja%20California.pdf' },
        { nombre: 'Ley de Responsabilidades Administrativas del Estado de Baja California', url: 'https://storage.googleapis.com/iurexia-leyes/bajacalifornia/Ley%20de%20Responsabilidades%20Administrativas%20del%20Estado%20de%20Baja%20California.pdf' },
        { nombre: 'Ley del Tribunal Estatal de Justicia Administrativa de Baja California', url: 'https://storage.googleapis.com/iurexia-leyes/bajacalifornia/Ley%20del%20Tribunal%20Estatal%20de%20Justicia%20Administrativa%20de%20Baja%20California.pdf' },
      ]
    } },
    { slug: 'baja-california-sur', nombre: 'Baja California Sur', nombreCorto: 'Baja California Sur', abreviatura: 'BCS', region: 'norte', leyesCount: 8, leyes: {
      constitucion: [],
      codigos: [],
      reglamentos: [],
      otros: [],
      leyes: [
        { nombre: 'CÓDIGO CIVIL PARA EL ESTADO LIBRE Y SOBERANO DE BAJA CALIFORNIA SUR', url: 'https://storage.googleapis.com/iurexia-leyes/bajacaliforniasur/C%C3%93DIGO%20CIVIL%20PARA%20EL%20ESTADO%20LIBRE%20Y%20SOBERANO%20DE%20BAJA%20CALIFORNIA%20SUR.pdf' },
        { nombre: 'código de procedimientos civiles para el estado de baja california sur', url: 'https://storage.googleapis.com/iurexia-leyes/bajacaliforniasur/c%C3%B3digo%20de%20procedimientos%20civiles%20para%20el%20estado%20de%20baja%20california%20sur.pdf' },
        { nombre: 'CÓDIGO FISCAL DEL ESTADO Y MUNICIPIOS DEL ESTADO DE BAJA CALIFORNIA SUR', url: 'https://storage.googleapis.com/iurexia-leyes/bajacaliforniasur/C%C3%93DIGO%20FISCAL%20DEL%20ESTADO%20Y%20MUNICIPIOS%20DEL%20ESTADO%20DE%20BAJA%20CALIFORNIA%20SUR.pdf' },
        { nombre: 'CÓDIGO PENAL PARA EL ESTADO LIBRE Y SOBERANO DE BAJA CALIFORNIA SUR', url: 'https://storage.googleapis.com/iurexia-leyes/bajacaliforniasur/C%C3%93DIGO%20PENAL%20PARA%20EL%20ESTADO%20LIBRE%20Y%20SOBERANO%20DE%20BAJA%20CALIFORNIA%20SUR.pdf' },
        { nombre: 'LEY DE ACCESO DE LAS MUJERES A UNA VIDA LIBRE DE VIOLENCIA PARA EL ESTADO DE BAJA CALIFORNIA SUR', url: 'https://storage.googleapis.com/iurexia-leyes/bajacaliforniasur/LEY%20DE%20ACCESO%20DE%20LAS%20MUJERES%20A%20UNA%20VIDA%20LIBRE%20DE%20VIOLENCIA%20PARA%20EL%20ESTADO%20DE%20BAJA%20CALIFORNIA%20SUR.pdf' },
        { nombre: 'LEY DE JUSTICIA ADMINISTRATIVA PARA EL EDO DE B.C.S.', url: 'https://storage.googleapis.com/iurexia-leyes/bajacaliforniasur/LEY%20DE%20JUSTICIA%20ADMINISTRATIVA%20PARA%20EL%20EDO%20DE%20B.C.S..pdf' },
        { nombre: 'LEY DE PROCEDIMIENTO ADMINISTRATIVO PARA EL ESTADO Y LOS MUNICIPIOS DE BAJA CALIFORNIA SUR', url: 'https://storage.googleapis.com/iurexia-leyes/bajacaliforniasur/LEY%20DE%20PROCEDIMIENTO%20ADMINISTRATIVO%20PARA%20EL%20ESTADO%20Y%20LOS%20MUNICIPIOS%20DE%20BAJA%20CALIFORNIA%20SUR.pdf' },
        { nombre: 'LEY DE PROCEDIMIENTO CONTENCIOSO ADMINISTRATIVO PARA EL ESTADO DE BAJA CALIFORNIA SUR', url: 'https://storage.googleapis.com/iurexia-leyes/bajacaliforniasur/LEY%20DE%20PROCEDIMIENTO%20CONTENCIOSO%20ADMINISTRATIVO%20PARA%20EL%20ESTADO%20DE%20BAJA%20CALIFORNIA%20SUR.pdf' },
      ]
    } },
    { slug: 'campeche', nombre: 'Campeche', nombreCorto: 'Campeche', abreviatura: 'CAMP', region: 'sur', leyesCount: 5, leyes: {
      constitucion: [],
      codigos: [],
      reglamentos: [],
      otros: [],
      leyes: [
        { nombre: 'Código Civil del Estado de Campeche', url: 'https://storage.googleapis.com/iurexia-leyes/campeche/C%C3%B3digo%20Civil%20del%20Estado%20de%20Campeche.pdf' },
        { nombre: 'Código de Procedimientos Penales del Estado de Campeche', url: 'https://storage.googleapis.com/iurexia-leyes/campeche/C%C3%B3digo%20de%20Procedimientos%20Penales%20del%20Estado%20de%20Campeche.pdf' },
        { nombre: 'Código Fiscal del Estado de Campeche', url: 'https://storage.googleapis.com/iurexia-leyes/campeche/C%C3%B3digo%20Fiscal%20del%20Estado%20de%20Campeche.pdf' },
        { nombre: 'Código Penal del Estado de Campeche', url: 'https://storage.googleapis.com/iurexia-leyes/campeche/C%C3%B3digo%20Penal%20del%20Estado%20de%20Campeche.pdf' },
        { nombre: 'Ley de Procedimiento Administrativo para el Estado y los Municipios de Campeche', url: 'https://storage.googleapis.com/iurexia-leyes/campeche/Ley%20de%20Procedimiento%20Administrativo%20para%20el%20Estado%20y%20los%20Municipios%20de%20Campeche.pdf' },
      ]
    } },
    { slug: 'chiapas', nombre: 'Chiapas', nombreCorto: 'Chiapas', abreviatura: 'CHIS', region: 'sur', leyesCount: 6, leyes: {
      constitucion: [],
      codigos: [],
      reglamentos: [],
      otros: [],
      leyes: [
        { nombre: 'Código Civil del Estado de Chiapas', url: 'https://storage.googleapis.com/iurexia-leyes/chiapas/C%C3%B3digo%20Civil%20del%20Estado%20de%20Chiapas.pdf' },
        { nombre: 'Código de la Hacienda Pública para el Estado de Chiapas', url: 'https://storage.googleapis.com/iurexia-leyes/chiapas/C%C3%B3digo%20de%20la%20Hacienda%20P%C3%BAblica%20para%20el%20Estado%20de%20Chiapas.pdf' },
        { nombre: 'Código de Procedimientos Civiles del Estado de Chiapas', url: 'https://storage.googleapis.com/iurexia-leyes/chiapas/C%C3%B3digo%20de%20Procedimientos%20Civiles%20del%20Estado%20de%20Chiapas.pdf' },
        { nombre: 'Código Penal para el Estado de Chiapas', url: 'https://storage.googleapis.com/iurexia-leyes/chiapas/C%C3%B3digo%20Penal%20para%20el%20Estado%20de%20Chiapas.pdf' },
        { nombre: 'Ley de Procedimientos Administrativos del Estado de Chiapas', url: 'https://storage.googleapis.com/iurexia-leyes/chiapas/Ley%20de%20Procedimientos%20Administrativos%20del%20Estado%20de%20Chiapas.pdf' },
        { nombre: 'LEY DE RESPONSABILIDADES ADMINISTRATIVAS PARA EL ESTADO DE CHIAPAS', url: 'https://storage.googleapis.com/iurexia-leyes/chiapas/LEY%20DE%20RESPONSABILIDADES%20ADMINISTRATIVAS%20PARA%20EL%20ESTADO%20DE%20CHIAPAS.pdf' },
      ]
    } },
    ...
    { slug: 'coahuila', nombre: 'Coahuila', nombreCorto: 'Coahuila', abreviatura: 'COAH', region: 'norte', leyesCount: 6, leyes: {
      constitucion: [],
      codigos: [],
      reglamentos: [],
      otros: [],
      leyes: [
        { nombre: 'Código Civil para el Estado de Coahuila de Zaragoza', url: 'https://storage.googleapis.com/iurexia-leyes/coahuila/C%C3%B3digo%20Civil%20para%20el%20Estado%20de%20Coahuila%20de%20Zaragoza.pdf' },
        { nombre: 'Código Fiscal para el Estado de Coahuila de Zaragoza', url: 'https://storage.googleapis.com/iurexia-leyes/coahuila/C%C3%B3digo%20Fiscal%20para%20el%20Estado%20de%20Coahuila%20de%20Zaragoza.pdf' },
        { nombre: 'Código Penal del Estado de Coahuila de Zaragoza', url: 'https://storage.googleapis.com/iurexia-leyes/coahuila/C%C3%B3digo%20Penal%20del%20Estado%20de%20Coahuila%20de%20Zaragoza.pdf' },
        { nombre: 'Código Procesal Civil para el Estado de Coahuila de Zaragoza', url: 'https://storage.googleapis.com/iurexia-leyes/coahuila/C%C3%B3digo%20Procesal%20Civil%20para%20el%20Estado%20de%20Coahuila%20de%20Zaragoza.pdf' },
        { nombre: 'Ley de Procedimiento Administrativo para el Estado de Coahuila de Zaragoza', url: 'https://storage.googleapis.com/iurexia-leyes/coahuila/Ley%20de%20Procedimiento%20Administrativo%20para%20el%20Estado%20de%20Coahuila%20de%20Zaragoza.pdf' },
        { nombre: 'Ley de Responsabilidades de los Servidores Públicos Estatales y Municipales del Estado de Coahuila de Zaragoza', url: 'https://storage.googleapis.com/iurexia-leyes/coahuila/Ley%20de%20Responsabilidades%20de%20los%20Servidores%20P%C3%BAblicos%20Estatales%20y%20Municipales%20del%20Estado%20de%20Coahuila%20de%20Zaragoza.pdf' },
      ]
    } },
    { slug: 'colima', nombre: 'Colima', nombreCorto: 'Colima', abreviatura: 'COL', region: 'occidente', leyesCount: 8, leyes: {
      constitucion: [],
      codigos: [],
      reglamentos: [],
      otros: [],
      leyes: [
        { nombre: 'Código Civil para el Estado de Colima', url: 'https://storage.googleapis.com/iurexia-leyes/colima/C%C3%B3digo%20Civil%20para%20el%20Estado%20de%20Colima.pdf' },
        { nombre: 'Código de Procedimientos Civiles para el Estado de Colima', url: 'https://storage.googleapis.com/iurexia-leyes/colima/C%C3%B3digo%20de%20Procedimientos%20Civiles%20para%20el%20Estado%20de%20Colima.pdf' },
        { nombre: 'Código Fiscal del Estado de Colima', url: 'https://storage.googleapis.com/iurexia-leyes/colima/C%C3%B3digo%20Fiscal%20del%20Estado%20de%20Colima.pdf' },
        { nombre: 'Código Penal para el Estado de Colima', url: 'https://storage.googleapis.com/iurexia-leyes/colima/C%C3%B3digo%20Penal%20para%20el%20Estado%20de%20Colima.pdf' },
        { nombre: 'Ley De Justicia Administrativa Del Estado De Colima', url: 'https://storage.googleapis.com/iurexia-leyes/colima/Ley%20De%20Justicia%20Administrativa%20Del%20Estado%20De%20Colima.pdf' },
        { nombre: 'Ley de Procedimiento Administrativo del Estado de Colima y sus Municipios', url: 'https://storage.googleapis.com/iurexia-leyes/colima/Ley%20de%20Procedimiento%20Administrativo%20del%20Estado%20de%20Colima%20y%20sus%20Municipios.pdf' },
        { nombre: 'Ley de Responsabilidad Patrimonial del Estado de Colima', url: 'https://storage.googleapis.com/iurexia-leyes/colima/Ley%20de%20Responsabilidad%20Patrimonial%20del%20Estado%20de%20Colima.pdf' },
        { nombre: 'Ley Estatal de Responsabilidades de los Servidores Públicos', url: 'https://storage.googleapis.com/iurexia-leyes/colima/Ley%20Estatal%20de%20Responsabilidades%20de%20los%20Servidores%20P%C3%BAblicos.pdf' },
      ]
    } },
    { slug: 'durango', nombre: 'Durango', nombreCorto: 'Durango', abreviatura: 'DGO', region: 'norte', leyesCount: 7, leyes: {
      constitucion: [],
      codigos: [],
      reglamentos: [],
      otros: [],
      leyes: [
        { nombre: 'Código Civil del Estado de Durango', url: 'https://storage.googleapis.com/iurexia-leyes/durango/C%C3%B3digo%20Civil%20del%20Estado%20de%20Durango.pdf' },
        { nombre: 'Código de Procedimientos Civiles para el Estado de Durango', url: 'https://storage.googleapis.com/iurexia-leyes/durango/C%C3%B3digo%20de%20Procedimientos%20Civiles%20para%20el%20Estado%20de%20Durango.pdf' },
        { nombre: 'Código Fiscal del Estado de Durango', url: 'https://storage.googleapis.com/iurexia-leyes/durango/C%C3%B3digo%20Fiscal%20del%20Estado%20de%20Durango.pdf' },
        { nombre: 'Código Penal para el Estado Libre y Soberano de Durango', url: 'https://storage.googleapis.com/iurexia-leyes/durango/C%C3%B3digo%20Penal%20para%20el%20Estado%20Libre%20y%20Soberano%20de%20Durango.pdf' },
        { nombre: 'Ley de Justicia Fiscal y Administrativa del Estado de Durango', url: 'https://storage.googleapis.com/iurexia-leyes/durango/Ley%20de%20Justicia%20Fiscal%20y%20Administrativa%20del%20Estado%20de%20Durango.pdf' },
        { nombre: 'Ley de Responsabilidad Patrimonial del Estado de Durango y sus Municipios', url: 'https://storage.googleapis.com/iurexia-leyes/durango/Ley%20de%20Responsabilidad%20Patrimonial%20del%20Estado%20de%20Durango%20y%20sus%20Municipios.pdf' },
        { nombre: 'Ley de Responsabilidades de los Servidores Públicos del Estado y de los Municipios', url: 'https://storage.googleapis.com/iurexia-leyes/durango/Ley%20de%20Responsabilidades%20de%20los%20Servidores%20P%C3%BAblicos%20del%20Estado%20y%20de%20los%20Municipios.pdf' },
      ]
    } },
    ...
    { slug: 'hidalgo', nombre: 'Hidalgo', nombreCorto: 'Hidalgo', abreviatura: 'HGO', region: 'centro', leyesCount: 9, leyes: {
      constitucion: [],
      codigos: [],
      reglamentos: [],
      otros: [],
      leyes: [
        { nombre: 'Código Civil para el Estado de Hidalgo', url: 'https://storage.googleapis.com/iurexia-leyes/hidalgo/C%C3%B3digo%20Civil%20para%20el%20Estado%20de%20Hidalgo.pdf' },
        { nombre: 'Código de Procedimientos Civiles para el Estado de Hidalgo', url: 'https://storage.googleapis.com/iurexia-leyes/hidalgo/C%C3%B3digo%20de%20Procedimientos%20Civiles%20para%20el%20Estado%20de%20Hidalgo.pdf' },
        { nombre: 'Código de Procedimientos Familiares para el Estado de Hidalgo', url: 'https://storage.googleapis.com/iurexia-leyes/hidalgo/C%C3%B3digo%20de%20Procedimientos%20Familiares%20para%20el%20Estado%20de%20Hidalgo.pdf' },
        { nombre: 'Código Fiscal del Estado de Hidalgo', url: 'https://storage.googleapis.com/iurexia-leyes/hidalgo/C%C3%B3digo%20Fiscal%20del%20Estado%20de%20Hidalgo.pdf' },
        { nombre: 'Código Penal para el Estado de Hidalgo', url: 'https://storage.googleapis.com/iurexia-leyes/hidalgo/C%C3%B3digo%20Penal%20para%20el%20Estado%20de%20Hidalgo.pdf' },
        { nombre: 'Ley De Responsabilidades Administrativas Del Estado De Hidalgo', url: 'https://storage.googleapis.com/iurexia-leyes/hidalgo/Ley%20De%20Responsabilidades%20Administrativas%20Del%20Estado%20De%20Hidalgo.pdf' },
        { nombre: 'Ley de Responsabilidades de los Servidores Públicos para el Estado de Hidalgo', url: 'https://storage.googleapis.com/iurexia-leyes/hidalgo/Ley%20de%20Responsabilidades%20de%20los%20Servidores%20P%C3%BAblicos%20para%20el%20Estado%20de%20Hidalgo.pdf' },
        { nombre: 'Ley Estatal del Procedimiento Administrativo para el Estado de Hidalgo', url: 'https://storage.googleapis.com/iurexia-leyes/hidalgo/Ley%20Estatal%20del%20Procedimiento%20Administrativo%20para%20el%20Estado%20de%20Hidalgo.pdf' },
        { nombre: 'LEY PARA LA FAMILIA DEL ESTADO DE HIDALGO', url: 'https://storage.googleapis.com/iurexia-leyes/hidalgo/LEY%20PARA%20LA%20FAMILIA%20DEL%20ESTADO%20DE%20HIDALGO.pdf' },
      ]
    } },
    ...
    { slug: 'nayarit', nombre: 'Nayarit', nombreCorto: 'Nayarit', abreviatura: 'NAY', region: 'occidente', leyesCount: 7, leyes: {
      constitucion: [],
      codigos: [],
      reglamentos: [],
      otros: [],
      leyes: [
        { nombre: 'Código Civil para el Estado de Nayarit', url: 'https://storage.googleapis.com/iurexia-leyes/nayarit/C%C3%B3digo%20Civil%20para%20el%20Estado%20de%20Nayarit.pdf' },
        { nombre: 'Código de Procedimientos Civiles para el Estado de Nayarit', url: 'https://storage.googleapis.com/iurexia-leyes/nayarit/C%C3%B3digo%20de%20Procedimientos%20Civiles%20para%20el%20Estado%20de%20Nayarit.pdf' },
        { nombre: 'Código Fiscal del Estado de Nayarit', url: 'https://storage.googleapis.com/iurexia-leyes/nayarit/C%C3%B3digo%20Fiscal%20del%20Estado%20de%20Nayarit.pdf' },
        { nombre: 'Código Penal para el Estado de Nayarit', url: 'https://storage.googleapis.com/iurexia-leyes/nayarit/C%C3%B3digo%20Penal%20para%20el%20Estado%20de%20Nayarit.pdf' },
        { nombre: 'Ley De Justicia Y Procedimientos Administrativos Del Estado De Nayari', url: 'https://storage.googleapis.com/iurexia-leyes/nayarit/Ley%20De%20Justicia%20Y%20Procedimientos%20Administrativos%20Del%20Estado%20De%20Nayari.pdf' },
        { nombre: 'Ley de Responsabilidad Patrimonial del Estado de Nayarit y sus Municipios', url: 'https://storage.googleapis.com/iurexia-leyes/nayarit/Ley%20de%20Responsabilidad%20Patrimonial%20del%20Estado%20de%20Nayarit%20y%20sus%20Municipios.pdf' },
        { nombre: 'Ley de Responsabilidades de los Servidores Públicos del Estado de Nayarit', url: 'https://storage.googleapis.com/iurexia-leyes/nayarit/Ley%20de%20Responsabilidades%20de%20los%20Servidores%20P%C3%BAblicos%20del%20Estado%20de%20Nayarit.pdf' },
      ]
    } },
    ...
    { slug: 'oaxaca', nombre: 'Oaxaca', nombreCorto: 'Oaxaca', abreviatura: 'OAX', region: 'sur', leyesCount: 7, leyes: {
      constitucion: [],
      codigos: [],
      reglamentos: [],
      otros: [],
      leyes: [
        { nombre: 'CODIGO DE PROCEDIMIENTOS CIVILES PARA EL ESTADO DE OAXACA', url: 'https://storage.googleapis.com/iurexia-leyes/oaxaca/CODIGO%20DE%20PROCEDIMIENTOS%20CIVILES%20PARA%20EL%20ESTADO%20DE%20OAXACA.pdf' },
        { nombre: 'CODIGO PENAL PARA EL ESTADO LIBRE Y SOBERANO DE OAXACA', url: 'https://storage.googleapis.com/iurexia-leyes/oaxaca/CODIGO%20PENAL%20PARA%20EL%20ESTADO%20LIBRE%20Y%20SOBERANO%20DE%20OAXACA.pdf' },
        { nombre: 'CÓDIGO FAMILIAR PARA EL ESTADO DE OAXACA', url: 'https://storage.googleapis.com/iurexia-leyes/oaxaca/C%C3%93DIGO%20FAMILIAR%20PARA%20EL%20ESTADO%20DE%20OAXACA.pdf' },
        { nombre: 'CÓDIGO FISCAL PARA EL ESTADO DE OAXACA', url: 'https://storage.googleapis.com/iurexia-leyes/oaxaca/C%C3%93DIGO%20FISCAL%20PARA%20EL%20ESTADO%20DE%20OAXACA.pdf' },
        { nombre: 'LEY DE PROCEDIMIENTO Y JUSTICIA ADMINISTRATIVA PARA EL ESTADO DE OAXACA', url: 'https://storage.googleapis.com/iurexia-leyes/oaxaca/LEY%20DE%20PROCEDIMIENTO%20Y%20JUSTICIA%20ADMINISTRATIVA%20PARA%20EL%20ESTADO%20DE%20OAXACA.pdf' },
        { nombre: 'LEY DE RESPONSABILIDAD PATRIMONIAL DEL ESTADO Y LOS MUNICIPIOS DE OAXACA', url: 'https://storage.googleapis.com/iurexia-leyes/oaxaca/LEY%20DE%20RESPONSABILIDAD%20PATRIMONIAL%20DEL%20ESTADO%20Y%20LOS%20MUNICIPIOS%20DE%20OAXACA.pdf' },
        { nombre: 'LEY DE RESPONSABILIDADES ADMINISTRATIVAS DEL ESTADO Y MUNICIPIOS DE OAXACA', url: 'https://storage.googleapis.com/iurexia-leyes/oaxaca/LEY%20DE%20RESPONSABILIDADES%20ADMINISTRATIVAS%20DEL%20ESTADO%20Y%20MUNICIPIOS%20DE%20OAXACA.pdf' },
      ]
    } },
    ...
    { slug: 'quintana-roo', nombre: 'Quintana Roo', nombreCorto: 'Quintana Roo', abreviatura: 'QROO', region: 'sur', leyesCount: 8, leyes: {
      constitucion: [],
      codigos: [],
      reglamentos: [],
      otros: [],
      leyes: [
        { nombre: 'Código Civil para el Estado de Quintana Roo', url: 'https://storage.googleapis.com/iurexia-leyes/quintanaroo/C%C3%B3digo%20Civil%20para%20el%20Estado%20de%20Quintana%20Roo.pdf' },
        { nombre: 'Código De Justicia Administrativa Del Estado De Quintana Roo', url: 'https://storage.googleapis.com/iurexia-leyes/quintanaroo/C%C3%B3digo%20De%20Justicia%20Administrativa%20Del%20Estado%20De%20Quintana%20Roo.pdf' },
        { nombre: 'Código de Procedimientos Civiles para el Estado Libre y Soberano de Quintana Roo', url: 'https://storage.googleapis.com/iurexia-leyes/quintanaroo/C%C3%B3digo%20de%20Procedimientos%20Civiles%20para%20el%20Estado%20Libre%20y%20Soberano%20de%20Quintana%20Roo.pdf' },
        { nombre: 'Código Fiscal del Estado de Quintana Roo', url: 'https://storage.googleapis.com/iurexia-leyes/quintanaroo/C%C3%B3digo%20Fiscal%20del%20Estado%20de%20Quintana%20Roo.pdf' },
        { nombre: 'Código Penal para el Estado Libre y Soberano de Quintana Roo', url: 'https://storage.googleapis.com/iurexia-leyes/quintanaroo/C%C3%B3digo%20Penal%20para%20el%20Estado%20Libre%20y%20Soberano%20de%20Quintana%20Roo.pdf' },
        { nombre: 'Ley de Justicia Administrativa del Estado de Quintana Roo', url: 'https://storage.googleapis.com/iurexia-leyes/quintanaroo/Ley%20de%20Justicia%20Administrativa%20del%20Estado%20de%20Quintana%20Roo.pdf' },
        { nombre: 'Ley de Procedimiento Administrativo del Estado de Quinatana Roo', url: 'https://storage.googleapis.com/iurexia-leyes/quintanaroo/Ley%20de%20Procedimiento%20Administrativo%20del%20Estado%20de%20Quinatana%20Roo.pdf' },
        { nombre: 'Ley de Responsabilidades de los Servidores Públicos del Estado', url: 'https://storage.googleapis.com/iurexia-leyes/quintanaroo/Ley%20de%20Responsabilidades%20de%20los%20Servidores%20P%C3%BAblicos%20del%20Estado.pdf' },
      ]
    } },
    { slug: 'san-luis-potosi', nombre: 'San Luis Potosí', nombreCorto: 'San Luis Potosí', abreviatura: 'SLP', region: 'centro', leyesCount: 9, leyes: {
      constitucion: [],
      codigos: [],
      reglamentos: [],
      otros: [],
      leyes: [
        { nombre: 'Código Civil para el Estado de San Luis Potosí', url: 'https://storage.googleapis.com/iurexia-leyes/sanluispotosi/C%C3%B3digo%20Civil%20para%20el%20Estado%20de%20San%20Luis%20Potos%C3%AD.pdf' },
        { nombre: 'Código de Procedimientos Civiles para el Estado de San Luis Potosí', url: 'https://storage.googleapis.com/iurexia-leyes/sanluispotosi/C%C3%B3digo%20de%20Procedimientos%20Civiles%20para%20el%20Estado%20de%20San%20Luis%20Potos%C3%AD.pdf' },
        { nombre: 'Código Familiar para el Estado de San Luis Potosí', url: 'https://storage.googleapis.com/iurexia-leyes/sanluispotosi/C%C3%B3digo%20Familiar%20para%20el%20Estado%20de%20San%20Luis%20Potos%C3%AD.pdf' },
        { nombre: 'Código Fiscal del Estado de San Luis Potosí', url: 'https://storage.googleapis.com/iurexia-leyes/sanluispotosi/C%C3%B3digo%20Fiscal%20del%20Estado%20de%20San%20Luis%20Potos%C3%AD.pdf' },
        { nombre: 'Código Penal del Estado de San Luis Potosí', url: 'https://storage.googleapis.com/iurexia-leyes/sanluispotosi/C%C3%B3digo%20Penal%20del%20Estado%20de%20San%20Luis%20Potos%C3%AD.pdf' },
        { nombre: 'Ley de Justicia Administrativa del Estado de San Luis Potosí', url: 'https://storage.googleapis.com/iurexia-leyes/sanluispotosi/Ley%20de%20Justicia%20Administrativa%20del%20Estado%20de%20San%20Luis%20Potos%C3%AD.pdf' },
        { nombre: 'Ley de Procedimientos Administrativos del Estado y Municipios de San Luis Potosí', url: 'https://storage.googleapis.com/iurexia-leyes/sanluispotosi/Ley%20de%20Procedimientos%20Administrativos%20del%20Estado%20y%20Municipios%20de%20San%20Luis%20Potos%C3%AD.pdf' },
        { nombre: 'Ley de Responsabilidad Patrimonial del Estado y Municipios de San Luis Potosí', url: 'https://storage.googleapis.com/iurexia-leyes/sanluispotosi/Ley%20de%20Responsabilidad%20Patrimonial%20del%20Estado%20y%20Municipios%20de%20San%20Luis%20Potos%C3%AD.pdf' },
        { nombre: 'Ley De Responsabilidades Administrativas Para El Estado Y Municipios De San Luis Potosí', url: 'https://storage.googleapis.com/iurexia-leyes/sanluispotosi/Ley%20De%20Responsabilidades%20Administrativas%20Para%20El%20Estado%20Y%20Municipios%20De%20San%20Luis%20Potos%C3%AD.pdf' },
      ]
    } },
    { slug: 'sinaloa', nombre: 'Sinaloa', nombreCorto: 'Sinaloa', abreviatura: 'SIN', region: 'norte', leyesCount: 149, ultimaActualizacion: '2026-03-16', leyes: SINALOA_LEYES },
    { slug: 'sonora', nombre: 'Sonora', nombreCorto: 'Sonora', abreviatura: 'SON', region: 'norte', leyesCount: 8, leyes: {
      constitucion: [],
      codigos: [],
      reglamentos: [],
      otros: [],
      leyes: [
        { nombre: 'Código Civil para el Estado de Sonora', url: 'https://storage.googleapis.com/iurexia-leyes/sonora/C%C3%B3digo%20Civil%20para%20el%20Estado%20de%20Sonora.pdf' },
        { nombre: 'Código de Familia para el Estado de Sonora', url: 'https://storage.googleapis.com/iurexia-leyes/sonora/C%C3%B3digo%20de%20Familia%20para%20el%20Estado%20de%20Sonora.pdf' },
        { nombre: 'Código de Procedimientos Civiles para el Estado de Sonora', url: 'https://storage.googleapis.com/iurexia-leyes/sonora/C%C3%B3digo%20de%20Procedimientos%20Civiles%20para%20el%20Estado%20de%20Sonora.pdf' },
        { nombre: 'Código Fiscal del Estado de Sonora', url: 'https://storage.googleapis.com/iurexia-leyes/sonora/C%C3%B3digo%20Fiscal%20del%20Estado%20de%20Sonora.pdf' },
        { nombre: 'Código Penal para el Estado de Sonora', url: 'https://storage.googleapis.com/iurexia-leyes/sonora/C%C3%B3digo%20Penal%20para%20el%20Estado%20de%20Sonora.pdf' },
        { nombre: 'Ley de Justicia Administrativa para el Estado de Sonora', url: 'https://storage.googleapis.com/iurexia-leyes/sonora/Ley%20de%20Justicia%20Administrativa%20para%20el%20Estado%20de%20Sonora.pdf' },
        { nombre: 'Ley de Responsabilidad Patrimonial para el Estado de Sonora y sus Municipios', url: 'https://storage.googleapis.com/iurexia-leyes/sonora/Ley%20de%20Responsabilidad%20Patrimonial%20para%20el%20Estado%20de%20Sonora%20y%20sus%20Municipios.pdf' },
        { nombre: 'Ley Estatal de Responsabilidades', url: 'https://storage.googleapis.com/iurexia-leyes/sonora/Ley%20Estatal%20de%20Responsabilidades.pdf' },
      ]
    } },
    { slug: 'tabasco', nombre: 'Tabasco', nombreCorto: 'Tabasco', abreviatura: 'TAB', region: 'sur', leyesCount: 7, leyes: {
      constitucion: [],
      codigos: [],
      reglamentos: [],
      otros: [],
      leyes: [
        { nombre: 'Código Civil para el Estado de Tabasco', url: 'https://storage.googleapis.com/iurexia-leyes/tabasco/C%C3%B3digo%20Civil%20para%20el%20Estado%20de%20Tabasco.pdf' },
        { nombre: 'Código de Procedimientos Civiles Para el Estado de Tabasco', url: 'https://storage.googleapis.com/iurexia-leyes/tabasco/C%C3%B3digo%20de%20Procedimientos%20Civiles%20Para%20el%20Estado%20de%20Tabasco.pdf' },
        { nombre: 'Código Fiscal para el Estado de Tabasco', url: 'https://storage.googleapis.com/iurexia-leyes/tabasco/C%C3%B3digo%20Fiscal%20para%20el%20Estado%20de%20Tabasco.pdf' },
        { nombre: 'Código Penal para el Estado de Tabasco', url: 'https://storage.googleapis.com/iurexia-leyes/tabasco/C%C3%B3digo%20Penal%20para%20el%20Estado%20de%20Tabasco.pdf' },
        { nombre: 'LEY DE JUSTICIA ADMINISTRATIVA DEL ESTADO DE TABASCO', url: 'https://storage.googleapis.com/iurexia-leyes/tabasco/LEY%20DE%20JUSTICIA%20ADMINISTRATIVA%20DEL%20ESTADO%20DE%20TABASCO.pdf' },
        { nombre: 'LEY DE RESPONSABILIDAD ADMINISTRATIVA DE LOS SERVIDORES PUBLICOS DEL ESTADO DE TABASCO', url: 'https://storage.googleapis.com/iurexia-leyes/tabasco/LEY%20DE%20RESPONSABILIDAD%20ADMINISTRATIVA%20DE%20LOS%20SERVIDORES%20PUBLICOS%20DEL%20ESTADO%20DE%20TABASCO.pdf' },
        { nombre: 'Ley De Responsabilidad Patrimonial Del Estado De Tabasco Y Sus Municipios', url: 'https://storage.googleapis.com/iurexia-leyes/tabasco/Ley%20De%20Responsabilidad%20Patrimonial%20Del%20Estado%20De%20Tabasco%20Y%20Sus%20Municipios.pdf' },
      ]
    } },
    { slug: 'tamaulipas', nombre: 'Tamaulipas', nombreCorto: 'Tamaulipas', abreviatura: 'TAMPS', region: 'norte', leyesCount: 8, leyes: {
      constitucion: [],
      codigos: [],
      reglamentos: [],
      otros: [],
      leyes: [
        { nombre: 'Código Civil para el Estado de Tamaulipas', url: 'https://storage.googleapis.com/iurexia-leyes/tamaulipas/C%C3%B3digo%20Civil%20para%20el%20Estado%20de%20Tamaulipas.pdf' },
        { nombre: 'Código de Procedimientos Civiles del Estado de Tamaulipas', url: 'https://storage.googleapis.com/iurexia-leyes/tamaulipas/C%C3%B3digo%20de%20Procedimientos%20Civiles%20del%20Estado%20de%20Tamaulipas.pdf' },
        { nombre: 'Código Fiscal del Estado de Tamaulipas', url: 'https://storage.googleapis.com/iurexia-leyes/tamaulipas/C%C3%B3digo%20Fiscal%20del%20Estado%20de%20Tamaulipas.pdf' },
        { nombre: 'Código Penal para el Estado de Tamaulipas', url: 'https://storage.googleapis.com/iurexia-leyes/tamaulipas/C%C3%B3digo%20Penal%20para%20el%20Estado%20de%20Tamaulipas.pdf' },
        { nombre: 'Ley de Procedimiento Administrativo para el Estado de Tamaulipas', url: 'https://storage.googleapis.com/iurexia-leyes/tamaulipas/Ley%20de%20Procedimiento%20Administrativo%20para%20el%20Estado%20de%20Tamaulipas.pdf' },
        { nombre: 'Ley de Responsabilidad Patrimonial del Estado de Tamaulipas y sus Municipios', url: 'https://storage.googleapis.com/iurexia-leyes/tamaulipas/Ley%20de%20Responsabilidad%20Patrimonial%20del%20Estado%20de%20Tamaulipas%20y%20sus%20Municipios.pdf' },
        { nombre: 'Ley de Responsabilidades Administrativas del Estado de Tamaulipas', url: 'https://storage.googleapis.com/iurexia-leyes/tamaulipas/Ley%20de%20Responsabilidades%20Administrativas%20del%20Estado%20de%20Tamaulipas.pdf' },
        { nombre: 'Ley del Procedimiento Contencioso Administrativo del Estado de Tamaulipas', url: 'https://storage.googleapis.com/iurexia-leyes/tamaulipas/Ley%20del%20Procedimiento%20Contencioso%20Administrativo%20del%20Estado%20de%20Tamaulipas.pdf' },
      ]
    } },
    { slug: 'tlaxcala', nombre: 'Tlaxcala', nombreCorto: 'Tlaxcala', abreviatura: 'TLAX', region: 'centro', leyesCount: 7, leyes: {
      constitucion: [],
      codigos: [],
      reglamentos: [],
      otros: [],
      leyes: [
        { nombre: 'CODIGO FINANCIERO PARA EL ESTADO DE TLAXCALA Y SUS MUNICIPIOS', url: 'https://storage.googleapis.com/iurexia-leyes/tlaxcala/CODIGO%20FINANCIERO%20PARA%20EL%20ESTADO%20DE%20TLAXCALA%20Y%20SUS%20MUNICIPIOS.pdf' },
        { nombre: 'Código Civil para el Estado Libre y Soberano de Tlaxcala', url: 'https://storage.googleapis.com/iurexia-leyes/tlaxcala/C%C3%B3digo%20Civil%20para%20el%20Estado%20Libre%20y%20Soberano%20de%20Tlaxcala.pdf' },
        { nombre: 'Código de Procedimientos Civiles para el Estado Libre y Soberano de Tlaxcala', url: 'https://storage.googleapis.com/iurexia-leyes/tlaxcala/C%C3%B3digo%20de%20Procedimientos%20Civiles%20para%20el%20Estado%20Libre%20y%20Soberano%20de%20Tlaxcala.pdf' },
        { nombre: 'Código Penal para el Estado Libre y Soberano de Tlaxcala', url: 'https://storage.googleapis.com/iurexia-leyes/tlaxcala/C%C3%B3digo%20Penal%20para%20el%20Estado%20Libre%20y%20Soberano%20de%20Tlaxcala.pdf' },
        { nombre: 'Ley de Responsabilidad Patrimonial del Estado de Tlaxcala', url: 'https://storage.googleapis.com/iurexia-leyes/tlaxcala/Ley%20de%20Responsabilidad%20Patrimonial%20del%20Estado%20de%20Tlaxcala.pdf' },
        { nombre: 'LEY DE RESPONSABILIDADES DE LOS SERVIDORES PUBLICOS PARA EL ESTADO DE TLAXCALA', url: 'https://storage.googleapis.com/iurexia-leyes/tlaxcala/LEY%20DE%20RESPONSABILIDADES%20DE%20LOS%20SERVIDORES%20PUBLICOS%20PARA%20EL%20ESTADO%20DE%20TLAXCALA.pdf' },
        { nombre: 'Ley del Procedimiento Administrativo del Estado de Tlaxcala y sus Municipios', url: 'https://storage.googleapis.com/iurexia-leyes/tlaxcala/Ley%20del%20Procedimiento%20Administrativo%20del%20Estado%20de%20Tlaxcala%20y%20sus%20Municipios.pdf' },
      ]
    } },
    ...
    { slug: 'yucatan', nombre: 'Yucatán', nombreCorto: 'Yucatán', abreviatura: 'YUC', region: 'sur', leyesCount: 10, leyes: {
      constitucion: [],
      codigos: [],
      reglamentos: [],
      otros: [],
      leyes: [
        { nombre: 'CÓDIGO CIVIL DEL ESTADO DE YUCATÁN', url: 'https://storage.googleapis.com/iurexia-leyes/yucatan/C%C3%93DIGO%20CIVIL%20DEL%20ESTADO%20DE%20YUCAT%C3%81N.pdf' },
        { nombre: 'CÓDIGO DE FAMILIA PARA EL ESTADO DE YUCATÁN', url: 'https://storage.googleapis.com/iurexia-leyes/yucatan/C%C3%93DIGO%20DE%20FAMILIA%20PARA%20EL%20ESTADO%20DE%20YUCAT%C3%81N.pdf' },
        { nombre: 'CÓDIGO DE PROCEDIMIENTOS CIVILES DE YUCATÁN', url: 'https://storage.googleapis.com/iurexia-leyes/yucatan/C%C3%93DIGO%20DE%20PROCEDIMIENTOS%20CIVILES%20DE%20YUCAT%C3%81N.pdf' },
        { nombre: 'CÓDIGO DEL REGISTRO CIVIL', url: 'https://storage.googleapis.com/iurexia-leyes/yucatan/C%C3%93DIGO%20DEL%20REGISTRO%20CIVIL.pdf' },
        { nombre: 'CÓDIGO FISCAL DEL ESTADO DE YUCATÁN', url: 'https://storage.googleapis.com/iurexia-leyes/yucatan/C%C3%93DIGO%20FISCAL%20DEL%20ESTADO%20DE%20YUCAT%C3%81N.pdf' },
        { nombre: 'CÓDIGO PENAL DEL ESTADO DE YUCATÁN', url: 'https://storage.googleapis.com/iurexia-leyes/yucatan/C%C3%93DIGO%20PENAL%20DEL%20ESTADO%20DE%20YUCAT%C3%81N.pdf' },
        { nombre: 'LEY DE ACTOS Y PROCEDIMIENTOS ADMINISTRATIVOS DEL ESTADO DE YUCATÁN', url: 'https://storage.googleapis.com/iurexia-leyes/yucatan/LEY%20DE%20ACTOS%20Y%20PROCEDIMIENTOS%20ADMINISTRATIVOS%20DEL%20ESTADO%20DE%20YUCAT%C3%81N.pdf' },
        { nombre: 'LEY DE LO CONTENCIOSO ADMINISTRATIVO DEL ESTADO DE YUCATÁN', url: 'https://storage.googleapis.com/iurexia-leyes/yucatan/LEY%20DE%20LO%20CONTENCIOSO%20ADMINISTRATIVO%20DEL%20ESTADO%20DE%20YUCAT%C3%81N.pdf' },
        { nombre: 'Ley De Responsabilidad Patrimonial Del Estado De Yucatán', url: 'https://storage.googleapis.com/iurexia-leyes/yucatan/Ley%20De%20Responsabilidad%20Patrimonial%20Del%20Estado%20De%20Yucat%C3%A1n.pdf' },
        { nombre: 'Ley de Responsabilidades Administrativas del Estado de Yucatán', url: 'https://storage.googleapis.com/iurexia-leyes/yucatan/Ley%20de%20Responsabilidades%20Administrativas%20del%20Estado%20de%20Yucat%C3%A1n.pdf' },
      ]
    } },
    { slug: 'zacatecas', nombre: 'Zacatecas', nombreCorto: 'Zacatecas', abreviatura: 'ZAC', region: 'norte', leyesCount: 8, leyes: {
      constitucion: [],
      codigos: [],
      reglamentos: [],
      otros: [],
      leyes: [
        { nombre: 'Código Civil del Estado de Zacatecas', url: 'https://storage.googleapis.com/iurexia-leyes/zacatecas/C%C3%B3digo%20Civil%20del%20Estado%20de%20Zacatecas.pdf' },
        { nombre: 'Código de Procedimientos Civiles para el Estado de Zacatecas', url: 'https://storage.googleapis.com/iurexia-leyes/zacatecas/C%C3%B3digo%20de%20Procedimientos%20Civiles%20para%20el%20Estado%20de%20Zacatecas.pdf' },
        { nombre: 'Código Familiar del Estado de Zacatecas', url: 'https://storage.googleapis.com/iurexia-leyes/zacatecas/C%C3%B3digo%20Familiar%20del%20Estado%20de%20Zacatecas.pdf' },
        { nombre: 'Código Fiscal del Estado de Zacatecas', url: 'https://storage.googleapis.com/iurexia-leyes/zacatecas/C%C3%B3digo%20Fiscal%20del%20Estado%20de%20Zacatecas.pdf' },
        { nombre: 'Código Penal para el Estado de Zacatecas', url: 'https://storage.googleapis.com/iurexia-leyes/zacatecas/C%C3%B3digo%20Penal%20para%20el%20Estado%20de%20Zacatecas.pdf' },
        { nombre: 'Ley de Procedimiento Administrativo del Estado y sus Municipios de Zacatecas', url: 'https://storage.googleapis.com/iurexia-leyes/zacatecas/Ley%20de%20Procedimiento%20Administrativo%20del%20Estado%20y%20sus%20Municipios%20de%20Zacatecas.pdf' },
        { nombre: 'Ley de Responsabilidades de los Servidores Públicos del Estado y Municipios de Zacatecas', url: 'https://storage.googleapis.com/iurexia-leyes/zacatecas/Ley%20de%20Responsabilidades%20de%20los%20Servidores%20P%C3%BAblicos%20del%20Estado%20y%20Municipios%20de%20Zacatecas.pdf' },
        { nombre: 'Ley del Tribunal de lo Contencioso Administrativo del Estado y los Municipios de Zacatecas', url: 'https://storage.googleapis.com/iurexia-leyes/zacatecas/Ley%20del%20Tribunal%20de%20lo%20Contencioso%20Administrativo%20del%20Estado%20y%20los%20Municipios%20de%20Zacatecas.pdf' },
      ]
    } },
];
