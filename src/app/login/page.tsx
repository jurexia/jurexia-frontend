        ...
        <main className="min-h-screen bg-cream-300 flex items-center justify-center px-4">
            <div className="w-full max-w-md">
                ...
                <div className="bg-white rounded-3xl shadow-xl p-8 border border-black/5">
                    ...
                    {/* Apple Login Button — disabled until Apple Developer Program activates */}
                    <div className="relative">
                        <button
                            disabled
                            className="w-full flex items-center justify-center gap-3 px-4 py-3 border-2 border-gray-300 bg-gray-100 text-gray-400 rounded-xl cursor-not-allowed mb-6 opacity-60"
                        >
                        ...
                        <span className="absolute -top-2 right-3 bg-[#c9a962] text-white text-[9px] font-bold px-2 py-0.5 rounded-full uppercase tracking-wider">Pronto</span>
                    </div>
