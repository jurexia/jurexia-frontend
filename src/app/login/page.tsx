                    ...
                    {showForgotPassword ? (
                        ...
                        <>
                            ...
                            <button
                                ...
                                className="w-full flex items-center justify-center gap-3 px-4 py-3 rounded-xl font-medium transition-all duration-200 mb-6 shadow-sm hover:shadow-md bg-white border border-gray-300 text-charcoal-700 hover:bg-gray-50"
                            >
