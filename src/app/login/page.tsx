    ...
    const handleForgotPassword = async (e: React.FormEvent) => {
        ...
        try {
            ...
            if (err.message?.includes('rate limit')) {
                setResetError('Demasiados intentos. Espera unos minutos.');
            } else {
                    ...
                    {showForgotPassword ? (
                        ...
                        resetSent ? (
                            ...
                            <div className="text-center">
                                ...
                                <p className="text-charcoal-900 font-medium text-sm mb-6">
                                    {resetEmail}
                                </p>
                                ...
                                <button
                                    ...
                                    className="text-accent-brown font-medium text-sm hover:underline"
                                >
                                    ← Volver al login
                                </button>
                            </div>
                            ...
                            <>
                                ...
                                <form onSubmit={handleForgotPassword} className="space-y-4">
                                    ...
                                    <div>
                                        <label htmlFor="resetEmail" className="block text-sm font-medium text-charcoal-700 mb-2">
                                            Email
                                        </label>
                                        <input
                                            id="resetEmail"
                        ...
                        <>
                            ...
                            <button
                                ...
                                className="w-full flex items-center justify-center gap-3 px-4 py-3 rounded-xl font-medium transition-all duration-200 mb-6 shadow-sm hover:shadow-md"
                            ...
                            >
                                ...
                                <span style={{ color: '#3c4043', fontWeight: 500 }}>Continuar con <span style={{ color: '#4285F4' }}>G</span><span style={{ color: '#EA4335' }}>o</span><span style={{ color: '#FBBC05' }}>o</span><span style={{ color: '#4285F4' }}>g</span><span style={{ color: '#34A853' }}>l</span><span style={{ color: '#EA4335' }}>e</span></span>
                            </button>

                            {/* Apple Login Button */}
                            <button
                                onClick={handleAppleLogin}
                                className="w-full flex items-center justify-center gap-3 px-4 py-3 rounded-xl font-medium transition-all duration-200 mb-6 shadow-sm hover:shadow-md bg-black text-white hover:bg-gray-900"
                            >
                            ...
                            <div className="relative my-6">
                                ...
                                <div className="relative flex justify-center text-sm">
                                    <span className="px-4 bg-white text-charcoal-400">o continúa con email</span>
                                </div>
                            </div>
                                    ...
                                    <div className="flex items-center justify-between mb-2">
                                        ...
                                        <button
                                            ...
                                            onClick={() => {
                                                ...
                                                setResetEmail(email); // Pre-fill with email if already typed
                                                setError('');
                                            }}
                                            className="text-xs text-accent-brown hover:underline font-medium"
                                        >
                            ...
                            <p className="text-center text-sm text-charcoal-500 mt-6">
                                ¿No tienes cuenta?{' '}
                                <Link href="/registro" className="text-accent-brown font-medium hover:underline">
                                    Regístrate gratis
                                </Link>
                            </p>
                        </>
