        ...
        <div className={`relative transition-all duration-500 ${centered ? 'w-full max-w-3xl' : 'w-full max-w-3xl mx-auto'}`}>
            ...
            {(attachedFile || extractingFile) && (
                <div className="absolute -top-12 left-0 right-0 flex justify-center">
                    <div className="inline-flex items-center gap-3 px-4 py-2 rounded-full bg-[#1a1f2e] border border-[#c9a962]/20 shadow-lg shadow-black/20 backdrop-blur-md animate-in fade-in slide-in-from-bottom-2">
                        {extractingFile ? (
                            <>
            ...
            <div className={`
                relative bg-[#1a1f2e] border transition-all duration-300 shadow-2xl overflow-hidden group
            ...
            {/* Gemini-style footer hint (only if centered) */}
            {centered && (
