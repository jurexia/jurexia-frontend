            ...
            <div className="w-full max-w-md">
                ...
                <div className="bg-white rounded-3xl shadow-xl p-8 border border-black/5">
                    ...
                    <button
                        ...
                        className="w-full flex items-center justify-center gap-3 px-4 py-3.5 rounded-xl font-medium transition-all duration-200 mb-3 shadow-md hover:shadow-lg"
                        style={{ background: '#e8f0fe', border: '2px solid #d2e3fc' }}
                    ...
                    {/* ★ Apple Login — disabled until Apple Developer Program activates ★ */}
                    <div className="relative">
                        <button
                            disabled
                            className="w-full flex items-center justify-center gap-3 px-4 py-3.5 rounded-xl font-medium mb-3 border-2 border-gray-300 bg-gray-100 text-gray-400 cursor-not-allowed opacity-60"
                        >
