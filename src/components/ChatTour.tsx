...
const TOUR_STEPS: TourStep[] = [
    ...
    {
        selector: '[data-guide="fuero-materia-filter"]',
        title: '⚖️ Fuero y Materia',
        description: 'Estos dos filtros son tu herramienta más poderosa para consultas precisas.\n\nFuero — Define el ámbito normativo:\n• Auto: Iurexia decide (recomendado).\n• Const.: CPEUM y tratados internacionales.\n• Federal: Leyes federales (LGTOC, LFT, CFF).\n• Estatal: Legislación local de tu estado.\n\nMateria — Enfoca el área jurídica:\n• Auto: búsqueda amplia en todas las materias.\n• Civil, Penal, Familiar, Admin: filtra resultados a esa rama específica.\n\nCombinar Fuero + Materia te da resultados extremadamente precisos sin necesidad de activar un Genio. Ideal para la mayoría de consultas.',
        padding: 10,
        preferBelow: true,
    },
    {
