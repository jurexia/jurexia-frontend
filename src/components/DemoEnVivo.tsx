...
export default function DemoEnVivo() {
    ...
    return (
        <section className="bg-cream-300 px-4 py-16 sm:px-6 sm:py-20">
            <div className="mx-auto max-w-5xl">

                <AnimatedSection animation="slide-up">
                    <div className="mx-auto max-w-2xl text-center">
                        <p className="font-serif text-2xl font-bold leading-tight text-charcoal-900 sm:text-3xl md:text-4xl">
                            Pregunta como le preguntarías a{' '}
                            <span className="text-accent-gold">un colega</span>
                        </p>
                        <p className="mt-4 text-base leading-relaxed text-charcoal-900/70 sm:text-lg">
                            La respuesta trae los criterios que la sostienen. Pulsa cualquiera
                            y se abre el documento oficial en la página exacta, con el texto
                            subrayado. Sin salir de la conversación.
                        </p>
                    </div>
                </AnimatedSection>
                ...
                <AnimatedSection animation="slide-up" delay={150}>
                    <figure className="mt-10 sm:mt-12">
                        ...
                        <div className="overflow-hidden rounded-xl border border-charcoal-900/10 bg-white shadow-[0_20px_60px_-20px_rgba(17,17,17,0.35)]">
                            <div className="flex items-center gap-2 border-b border-charcoal-900/[0.07] bg-charcoal-900/[0.03] px-4 py-2.5">
                            ...
                            <div className="group relative">
                                <video
                                    ...
                                    aria-label="Demostración: una consulta sobre prisión preventiva oficiosa, la respuesta con sus criterios y el PDF oficial de la Constitución abierto en el artículo citado."
                                >
                                    ...
                                    <source src="/demo/consulta.mp4" type="video/mp4" />
                                </video>
                ...
                <AnimatedSection animation="slide-up" delay={300}>
                    <div className="mt-10 text-center">
                        ...
                        >
                            Pruébalo con tu propia consulta
                        </Link>
                        <p className="mt-3 text-[13px] text-charcoal-900/50">
                            Plan gratuito, sin tarjeta. Se registra en un minuto.
                        </p>
                    </div>
                </AnimatedSection>
            </div>
