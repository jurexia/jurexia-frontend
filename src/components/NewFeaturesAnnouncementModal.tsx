                ...
                <div className="px-8 pt-6 pb-8 min-h-[420px] flex flex-col">
                    {step === 0 && (
                        <div className="flex flex-col items-center text-center animate-fade-in">
                            ...
                            <span className="text-[10px] font-semibold tracking-[0.2em] text-[#c9a962] mb-2">FUNCIONES EXCLUSIVAS</span>
                            <h2 className="text-2xl font-serif text-white mb-3">Nuevas herramientas disponibles</h2>
                            <p className="text-white/60 text-sm leading-relaxed max-w-md mb-6">
                                Hemos liberado herramientas que elevan la calidad de tu trabajo jurídico. Te guiamos en 60 segundos para que las aproveches al máximo.
                            </p>
                            <div className="grid grid-cols-3 gap-3 w-full mt-2">
                                <div className="px-3 py-3 rounded-xl bg-white/[0.02] border border-white/5 hover:border-[#c9a962]/30 transition-colors">
                                    <Sparkles className="w-4 h-4 text-[#c9a962] mb-2 mx-auto" />
                                    <div className="text-white text-xs font-medium">Redacción Pro</div>
                                    <div className="text-white/40 text-[10px] mt-0.5">Razonamiento avanzado</div>
                                </div>
                                <div className="px-3 py-3 rounded-xl bg-white/[0.02] border border-white/5 hover:border-[#c9a962]/30 transition-colors">
                                    <BookOpen className="w-4 h-4 text-[#c9a962] mb-2 mx-auto" />
                    ...
                    {step === 2 && (
                        <div className="flex flex-col animate-fade-in">
                            <div className="flex items-center gap-3 mb-4">
                                ...
                                <div>
                                    <span className="text-[10px] font-semibold tracking-[0.2em] text-[#c9a962]">JURIMETRÍA · PRECEDENTES TCC</span>
                            ...
                            <div className="rounded-xl bg-white/[0.02] border border-white/5 p-4 mb-3">
                                ...
                                <ul className="space-y-2.5">
                                    <li className="flex items-start gap-3 text-white/70 text-[13px] leading-snug">
                                        ...
                                        Buscar sentencias de un circuito específico (1°, 2°, 3°, 4°, 6°, 16°, 22° y más en camino) o globalmente.
                                    </li>
                                    <li className="flex items-start gap-3 text-white/70 text-[13px] leading-snug">
                                        <Scale className="w-3.5 h-3.5 text-[#c9a962] flex-shrink-0 mt-0.5" />
                        ...
                        <div className="flex flex-col animate-fade-in">
                            <div className="flex items-center gap-3 mb-4">
                                <div className="relative">
                                    ...
                                    <div className="relative w-12 h-12 rounded-full bg-gradient-to-br from-red-600 via-red-500 to-[#c9a962] flex items-center justify-center">
                                        <FileText className="w-6 h-6 text-white" />
                                    </div>
                                </div>
                                <div>
                                    <div className="flex items-center gap-2">
                                        <span className="text-[10px] font-semibold tracking-[0.2em] text-red-400">REDACTOR TCC BETA</span>
                                        <span className="px-1.5 py-0.5 rounded-full bg-red-600/20 border border-red-500/30 text-red-400 text-[9px] font-bold">NUEVO</span>
                                    </div>
                                    <h2 className="text-xl font-serif text-white">Borradores de sentencia con IA</h2>
                                </div>
                            </div>

                            <p className="text-white/70 text-sm leading-relaxed mb-4">
                                Genera un <span className="text-[#c9a962] font-medium">borrador completo de Estudio de Fondo</span> para sentencias de Tribunales Colegiados de Circuito.
                                Sube el acto reclamado y los conceptos de violación, y el pipeline analiza, busca precedentes y redacta un proyecto estructurado.
                            </p>

                            <div className="rounded-xl bg-white/[0.02] border border-white/5 p-4 mb-3">
                                <div className="text-[10px] font-semibold tracking-[0.15em] text-white/40 mb-3">CÓMO FUNCIONA</div>
                                <ol className="space-y-2.5">
                                    <li className="flex items-start gap-3">
                                        <span className="flex-shrink-0 w-5 h-5 rounded-full bg-red-600/20 text-red-400 text-[11px] font-semibold flex items-center justify-center mt-0.5">1</span>
                                        <div className="text-white/70 text-[13px] leading-snug">
                                            Sube los documentos del expediente (acto reclamado y conceptos de violación).
                                        </div>
                                    </li>
                                    <li className="flex items-start gap-3">
                                        <span className="flex-shrink-0 w-5 h-5 rounded-full bg-red-600/20 text-red-400 text-[11px] font-semibold flex items-center justify-center mt-0.5">2</span>
                                        <div className="text-white/70 text-[13px] leading-snug">
                                            La IA analiza los documentos, identifica los problemas jurídicos y consulta nuestra base de datos de tesis, normas y precedentes.
                                        </div>
                                    </li>
                                    <li className="flex items-start gap-3">
                                        <span className="flex-shrink-0 w-5 h-5 rounded-full bg-red-600/20 text-red-400 text-[11px] font-semibold flex items-center justify-center mt-0.5">3</span>
                                        <div className="text-white/70 text-[13px] leading-snug">
                                            Recibes un borrador de Estudio de Fondo estructurado, con citas a tesis y precedentes relevantes.
                                        </div>
                                    </li>
                                    <li className="flex items-start gap-3">
                                        <span className="flex-shrink-0 w-5 h-5 rounded-full bg-red-600/20 text-red-400 text-[11px] font-semibold flex items-center justify-center mt-0.5">4</span>
                                        <div className="text-white/70 text-[13px] leading-snug">
                                            Al final, te proporcionamos precedentes similares de tu órgano u otros Tribunales que puedes consultar en PDF para refinar tu proyecto.
                                        </div>
                                    </li>
                                </ol>
                            </div>

                            <div className="flex items-start gap-2 px-3 py-2 rounded-lg bg-red-600/5 border border-red-500/20">
                                <Crown className="w-3.5 h-3.5 text-[#c9a962] flex-shrink-0 mt-0.5" />
                                <p className="text-white/60 text-[11px] leading-relaxed">
                                    <span className="text-[#c9a962] font-medium">Exclusivo plan Platinum.</span> Cada generación consume 10 consultas. Solo se cobran si el borrador se genera exitosamente.
                                </p>
                            </div>
                        </div>
                    )}
                    ...
                    <div className="flex items-center justify-between mt-auto pt-6">
                        ...
                        {step < TOTAL_STEPS - 1 ? (
                            ...
                            <div className="flex items-center gap-2">
                                <button
                                    onClick={onClose}
                                    className="px-4 py-2 rounded-lg text-white/50 hover:text-white/80 text-sm font-medium transition-colors"
                                >
                                    Cerrar
                                </button>
                                <Link
                                    href="/tcc-beta"
                                    onClick={onClose}
                                    className="flex items-center gap-1.5 px-4 py-2 rounded-lg bg-gradient-to-r from-red-600 to-[#c9a962] text-white text-sm font-semibold hover:shadow-[0_0_16px_rgba(220,38,38,0.4)] transition-all"
                                >
                                    Ir al Redactor TCC Beta
                                    <ChevronRight className="w-4 h-4" />
                                </Link>
                            </div>
                        )}
